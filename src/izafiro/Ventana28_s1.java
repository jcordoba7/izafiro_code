 ...
 * @author Jacc89
 */
public final class Ventana28_s1 extends javax.swing.JFrame {
    ...
    public Ventana28_s1() {
        ...
        this.addKeyListener(new Ventana28_s1.AL());//ActionListener para el movimiento del personaje   
    ...
    private void initComponents() {
        ...
        palito1 = new javax.swing.JLabel();
        palito2 = new javax.swing.JLabel();
        ...
        getContentPane().add(cascada1, new org.netbeans.lib.awtextra.AbsoluteConstraints(167, -60, 121, 88));
        ...
        getContentPane().add(cascada3, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, -60, 121, 88));
        ...
        getContentPane().add(sombra1, new org.netbeans.lib.awtextra.AbsoluteConstraints(375, 240, 0, 0));
        ...
        arbol1.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        getContentPane().add(arbol1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 121, -1, 136));

        objeto1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/columna.png"))); // NOI18N
        getContentPane().add(objeto1, new org.netbeans.lib.awtextra.AbsoluteConstraints(748, 249, -1, -1));

        palito1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        palito1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/palito.png"))); // NOI18N
        getContentPane().add(palito1, new org.netbeans.lib.awtextra.AbsoluteConstraints(396, 414, -1, -1));

        palito2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        palito2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/palito.png"))); // NOI18N
        getContentPane().add(palito2, new org.netbeans.lib.awtextra.AbsoluteConstraints(492, 414, -1, -1));

        roca2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/rocaizq.gif"))); // NOI18N
        getContentPane().add(roca2, new org.netbeans.lib.awtextra.AbsoluteConstraints(545, 360, -1, -1));

        roca1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/rocader.gif"))); // NOI18N
        getContentPane().add(roca1, new org.netbeans.lib.awtextra.AbsoluteConstraints(275, 80, -1, -1));

        roca4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/rocaaba.gif"))); // NOI18N
        getContentPane().add(roca4, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 360, -1, -1));

        roca3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/rocaaba.gif"))); // NOI18N
        getContentPane().add(roca3, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 90, -1, -1));
        ...
        getContentPane().add(lobo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 240, -1, -1));
        ...
        getContentPane().add(tahi, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 140, -1, -1));
        ...
        arbol2.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        getContentPane().add(arbol2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 121, -1, -1));
        getContentPane().add(obstaculo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(165, 290, 85, 180));
        getContentPane().add(obstaculo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(165, 60, 85, 160));
        getContentPane().add(obstaculo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(645, 50, 55, 170));
        getContentPane().add(obstaculo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(485, 0, 310, 60));
        getContentPane().add(obstaculo5, new org.netbeans.lib.awtextra.AbsoluteConstraints(67, 25, 100, 110));
        getContentPane().add(obstaculo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(485, 450, 190, 140));
        getContentPane().add(obstaculo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(645, 290, 55, 190));
        getContentPane().add(obstaculo8, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 352, 120, 230));
        getContentPane().add(obstaculo9, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 8, 110, 150));
        getContentPane().add(obstaculo10, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 450, 180, 140));
        getContentPane().add(obstaculo11, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 120, 50));
        getContentPane().add(obstaculo12, new org.netbeans.lib.awtextra.AbsoluteConstraints(212, 0, 200, 60));
        getContentPane().add(obstaculo13, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 460, 200, 130));
        getContentPane().add(obstaculo14, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 247, 20, 10));
        getContentPane().add(obstaculo15, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 115, 48, 73));
        getContentPane().add(obstaculo16, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 315, 50, 30));
        getContentPane().add(obstaculo17, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 155, 310, 210));
        getContentPane().add(guardado, new org.netbeans.lib.awtextra.AbsoluteConstraints(17, 25, 150, 150));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/escenarios/escenario1/v28.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana28_s1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Ventana28_s1().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel palito1;
    private javax.swing.JLabel palito2;
    ...
    private void cargarPersonajes() {
       ...
       Icon i3 = new ImageIcon (getClass().getResource("imagenes/objetos/rocader.gif"));
       Icon i4 = new ImageIcon (getClass().getResource("imagenes/objetos/rocaizq.gif"));
       
       
       new Rodante(this,tahi,"horizontal",545,275,roca1,i3,i4,3,45,10,5).start();
       new Rodante(this,tahi,"horizontal",545,275,roca2,i3,i4,3,45,10,5).start();
       new Rodante(this,tahi,"vertical",90,360,roca3,i1,i2,3,45,10,10).start();
       new Rodante(this,tahi,"vertical",90,360,roca4,i1,i2,3,45,10,10).start();       
       ...
       JLabel o = obstaculo17;  //Obstaculo que delimita a los enemigos, no a Tahi. 
    ...
    {       
        ...
        public void keyPressed(KeyEvent e)
        {
            ...
            if(i==0)
            {
                ...
                if(GestorJuego.getInstance().getPuertas()[3])
                {
                    arbol1.setIcon(new ImageIcon (getClass().getResource("imagenes/objetos/arbol8.png")));
                    arbol2.setIcon(new ImageIcon (getClass().getResource("imagenes/objetos/arbol8.png")));
