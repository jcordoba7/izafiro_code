 ...
 * @author Jacc89
 */
public final class Ventana07_s1 extends javax.swing.JFrame {
    ...
    public Ventana07_s1() {
        ...
        this.addKeyListener(new Ventana07_s1.AL());//ActionListener para el movimiento del personaje   
    ...
    private void initComponents() {
        ...
        arboles.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        arboles.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/arboles3.png"))); // NOI18N
        arboles.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        getContentPane().add(arboles, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 400, 650, 90));
        ...
        getContentPane().add(objeto2, new org.netbeans.lib.awtextra.AbsoluteConstraints(359, 243, -1, 80));

        objeto3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ...
        getContentPane().add(objeto3, new org.netbeans.lib.awtextra.AbsoluteConstraints(719, 165, 80, 135));

        objeto4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/arbol6.png"))); // NOI18N
        getContentPane().add(objeto4, new org.netbeans.lib.awtextra.AbsoluteConstraints(-55, 317, -1, -1));

        objeto5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/arbol6.png"))); // NOI18N
        getContentPane().add(objeto5, new org.netbeans.lib.awtextra.AbsoluteConstraints(-62, 218, -1, -1));
        ...
        getContentPane().add(objeto6, new org.netbeans.lib.awtextra.AbsoluteConstraints(597, 407, -1, 90));

        objeto7.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        objeto7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/arbol6.png"))); // NOI18N
        objeto7.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        getContentPane().add(objeto7, new org.netbeans.lib.awtextra.AbsoluteConstraints(684, 399, 115, 90));
        ...
        gema.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/barra/recursos/recurso5.png"))); // NOI18N
        getContentPane().add(gema, new org.netbeans.lib.awtextra.AbsoluteConstraints(392, 68, -1, -1));

        objeto1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/columna2.png"))); // NOI18N
        getContentPane().add(objeto1, new org.netbeans.lib.awtextra.AbsoluteConstraints(391, 83, -1, -1));
        ...
        getContentPane().add(cascada, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 20, 85, 88));
        ...
        getContentPane().add(cascada2, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 20, 87, 88));
        ...
        getContentPane().add(cascada3, new org.netbeans.lib.awtextra.AbsoluteConstraints(443, 20, 81, 88));
        getContentPane().add(obstaculo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 350, 220));
        getContentPane().add(obstaculo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 100, 240, 220));
        getContentPane().add(obstaculo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 30, 490));
        getContentPane().add(obstaculo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 125, 110, 0));
        getContentPane().add(obstaculo5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 470, 800, 20));
        getContentPane().add(obstaculo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 265, 120, 0));
        getContentPane().add(obstaculo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 240, 20, 60));
        getContentPane().add(obstaculo8, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 310, 20, 10));
        getContentPane().add(obstaculo9, new org.netbeans.lib.awtextra.AbsoluteConstraints(433, 310, 20, 10));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/escenarios/escenario1/v07.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana07_s1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Ventana07_s1().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel gema;
    ...
    private void cargarPersonajes() {
       ...
       ArrayList<Conversacion>conversaciones1 = new ArrayList<>();
        ...
        dialogo0.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[0,7]/conversador1/dialogo1/1.png")));      
        dialogo0.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[0,7]/conversador1/dialogo1/2.png")));
        dialogo0.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[0,7]/conversador1/dialogo1/3.png")));
        dialogo0.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[0,7]/conversador1/dialogo1/4.png")));
        
        Conversacion dialogo1 = new Conversacion();
        dialogo1.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[0,7]/conversador1/dialogo2/1.png")));      
        dialogo1.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[0,7]/conversador1/dialogo2/2.png")));
        
        Conversacion dialogo2 = new Conversacion();
        dialogo2.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[0,7]/conversador1/dialogo2/3.png")));      
       ...
       Conversador conversador1 = new Conversador(0,obstaculo4,conversaciones1);
   ...
   public void imprimirMensaje(Conversador c)
    {  
       ...
       else
       {
         ...
         {
           if(!cuadroDialogo.getIcon().toString().contains("conversador1/dialogo1/4") || puzzle)
           {
    ...
    {       
        ...
        public void keyPressed(KeyEvent e)
        {
            ...
            switch(keyCode)
            {
                ...
                case (KeyEvent.VK_Y): if(cuadroDialogo.getIcon().toString().contains("conversador1/dialogo1/4"))
                                      {                                          
                                        PruebaPuzzle.getInstance().abrirActividad(6,GestorJuego.getInstance().getvJF()[getNumVentanaFila()][getNumVentanaColm()],new Point(tahi.getX(),tahi.getY()));
                                        conversadores.get(0).setDialogoActual(conversadores.get(0).getDialogoActual()+1);  
                                        Sonidos.getInstance().detener(clip1);i=0;
                                        puzzle = true;
                                      }else if(cuadroDialogo.getIcon().toString().contains("conversador1/dialogo2/3"))
                                      {
                                        PruebaPuzzle.getInstance().abrirActividad(6,GestorJuego.getInstance().getvJF()[getNumVentanaFila()][getNumVentanaColm()],new Point(tahi.getX(),tahi.getY()));
                                        Sonidos.getInstance().detener(clip1);i=0;  
                                      }
        ...
        {          
          if(cuadroDialogo.getIcon().toString().contains("conversador1/dialogo2/2")) //Se le dará la gema
          { 
            GestorJuego.getInstance().agregarRecurso(5); //gema 1 es el recurso No 5. 
