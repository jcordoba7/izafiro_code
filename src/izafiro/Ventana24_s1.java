 ...
 * @author Jacc89
 */
public final class Ventana24_s1 extends javax.swing.JFrame {
    ...
    public Ventana24_s1() {
        ...
        this.addKeyListener(new Ventana24_s1.AL());//ActionListener para el movimiento del personaje        
    }
    ...
    private void initComponents() {
        ...
        letrero.setText("Valle de la Roca");
        ...
        getContentPane().add(letrero, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 200, 0, 0));
        ...
        getContentPane().add(roca4, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 350, -1, -1));

        roca3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/rocaaba.gif"))); // NOI18N
        getContentPane().add(roca3, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 50, -1, -1));

        roca2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/rocaizq.gif"))); // NOI18N
        getContentPane().add(roca2, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 340, -1, -1));

        roca1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/rocader.gif"))); // NOI18N
        getContentPane().add(roca1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 250, -1, -1));

        sombra.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/sombra3.png"))); // NOI18N
        getContentPane().add(sombra, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 130, -1, -1));
        ...
        objeto1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/arbol4.png"))); // NOI18N
        objeto1.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        getContentPane().add(objeto1, new org.netbeans.lib.awtextra.AbsoluteConstraints(268, -73, -1, 245));
        ...
        getContentPane().add(troncoTiempo, new org.netbeans.lib.awtextra.AbsoluteConstraints(117, 100, 80, -1));
        troncoTiempo.getAccessibleContext().setAccessibleName("troncoTiempo");

        getContentPane().add(obstaculo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 0, 60, 265));
        getContentPane().add(obstaculo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, 80, 110));
        getContentPane().add(obstaculo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(75, 96, 170, 60));
        getContentPane().add(obstaculo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(147, 26, 350, 100));
        getContentPane().add(obstaculo5, new org.netbeans.lib.awtextra.AbsoluteConstraints(367, 170, 60, 10));
        getContentPane().add(obstaculo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(121, 240, 0, 90));
        getContentPane().add(obstaculo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 243, 380, 15));
        getContentPane().add(obstaculo8, new org.netbeans.lib.awtextra.AbsoluteConstraints(191, 345, 0, 70));
        getContentPane().add(obstaculo9, new org.netbeans.lib.awtextra.AbsoluteConstraints(443, 243, 0, 85));
        getContentPane().add(obstaculo10, new org.netbeans.lib.awtextra.AbsoluteConstraints(516, 340, 0, 80));
        getContentPane().add(obstaculo11, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 422, 800, 170));
        getContentPane().add(obstaculo12, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 340, 40, 120));
        getContentPane().add(obstaculo13, new org.netbeans.lib.awtextra.AbsoluteConstraints(564, 140, 0, 280));
        getContentPane().add(obstaculo14, new org.netbeans.lib.awtextra.AbsoluteConstraints(568, 120, 60, 10));
        getContentPane().add(obstaculo15, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 360, 70, 15));
        getContentPane().add(obstaculo16, new org.netbeans.lib.awtextra.AbsoluteConstraints(726, 25, 0, 340));
        getContentPane().add(obstaculo17, new org.netbeans.lib.awtextra.AbsoluteConstraints(504, 115, 0, 130));
        getContentPane().add(obstaculo18, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 217, 60, 50));
        getContentPane().add(obstaculo19, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 5, 270, 40));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/escenarios/escenario1/v24.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana24_s1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Ventana24_s1().setVisible(true);
            }
        });
    }
    ...
    private void cargarPersonajes() {
       ...
       Icon i3 = new ImageIcon (getClass().getResource("imagenes/objetos/rocaarr.gif"));
       Icon i4 = new ImageIcon (getClass().getResource("imagenes/objetos/rocaaba.gif"));
       
       new Rodante(this,tahi,"horizontal",360,130,roca1,i1,i2,3,55,10,5).start();
       new Rodante(this,tahi,"horizontal",430,200,roca2,i1,i2,3,55,10,5).start();
       new Rodante(this,tahi,"vertical",50,280,roca3,i3,i4,3,55,5,15).start();
       new Rodante(this,tahi,"vertical",120,350,roca4,i3,i4,3,55,5,15).start();
    }
