 ...
 * @author Jacc89
 */
public final class Ventana21_s1 extends javax.swing.JFrame {
    ...
    public Ventana21_s1() {
        ...
        this.addKeyListener(new Ventana21_s1.AL());//ActionListener para el movimiento del personaje
    }
    ...
    private void initComponents() {
        ...
        bat7 = new javax.swing.JLabel();
        bat8 = new javax.swing.JLabel();
        ...
        objeto2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/arbol9.png"))); // NOI18N
        objeto2.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        getContentPane().add(objeto2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 255, 130, -1));

        objeto3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        objeto3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/arbol9.png"))); // NOI18N
        objeto3.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        getContentPane().add(objeto3, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 65, 130, -1));

        objeto4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        objeto4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/arbol9.png"))); // NOI18N
        objeto4.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        getContentPane().add(objeto4, new org.netbeans.lib.awtextra.AbsoluteConstraints(495, 120, 130, -1));
        ...
        getContentPane().add(objeto5, new org.netbeans.lib.awtextra.AbsoluteConstraints(-74, 22, -1, 317));
        ...
        espadazo.getAccessibleContext().setAccessibleName("espadazo");
        ...
        getContentPane().add(bat1, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 220, -1, -1));
        ...
        getContentPane().add(bat2, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 320, -1, -1));

        bat3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        bat3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/personajes/bat/bat1.gif"))); // NOI18N
        getContentPane().add(bat3, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 320, -1, -1));
        ...
        getContentPane().add(bat4, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 420, -1, -1));

        bat5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        bat5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/personajes/bat/bat1.gif"))); // NOI18N
        getContentPane().add(bat5, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 420, -1, -1));

        bat6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        bat6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/personajes/bat/bat1.gif"))); // NOI18N
        getContentPane().add(bat6, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 420, -1, -1));

        bat7.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        bat7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/personajes/bat/bat1.gif"))); // NOI18N
        getContentPane().add(bat7, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 220, -1, -1));

        bat8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        bat8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/personajes/bat/bat1.gif"))); // NOI18N
        getContentPane().add(bat8, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 220, -1, -1));

        tahi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/personajes/tahi/tahi2.png"))); // NOI18N
        getContentPane().add(tahi, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 0, -1, -1));
        tahi.getAccessibleContext().setAccessibleName("tahi");

        getContentPane().add(obstaculo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(638, 0, 160, 120));
        getContentPane().add(obstaculo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 77, 150, 390));
        getContentPane().add(obstaculo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(74, 67, 270, 55));
        getContentPane().add(obstaculo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 77, 80, 90));
        getContentPane().add(obstaculo5, new org.netbeans.lib.awtextra.AbsoluteConstraints(403, 67, 360, 90));
        getContentPane().add(obstaculo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 373, 117, 110));
        getContentPane().add(obstaculo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 455, 580, 30));
        getContentPane().add(obstaculo8, new org.netbeans.lib.awtextra.AbsoluteConstraints(263, 359, 460, 50));
        getContentPane().add(obstaculo9, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 258, 390, 55));
        getContentPane().add(obstaculo10, new org.netbeans.lib.awtextra.AbsoluteConstraints(646, 133, 50, 240));
        getContentPane().add(obstaculo11, new org.netbeans.lib.awtextra.AbsoluteConstraints(681, 290, 50, 100));
        getContentPane().add(obstaculo12, new org.netbeans.lib.awtextra.AbsoluteConstraints(772, 225, 25, 250));
        getContentPane().add(obstaculo13, new org.netbeans.lib.awtextra.AbsoluteConstraints(742, 196, 20, 50));
        getContentPane().add(obstaculo14, new org.netbeans.lib.awtextra.AbsoluteConstraints(262, 162, 210, 55));
        getContentPane().add(obstaculo15, new org.netbeans.lib.awtextra.AbsoluteConstraints(518, 204, 82, 80));
        getContentPane().add(obstaculo16, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 20, 400));
        getContentPane().add(obstaculo17, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 479, 20));
        getContentPane().add(obstaculo18, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 80, 560, 390));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/escenarios/escenario1/v21.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana21_s1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Ventana21_s1().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel bat7;
    private javax.swing.JLabel bat8;
    ...
    private void cargarPersonajes() {
       ...
       Conversador conversador3 = new Conversador(0,bat3,null);
       conversador3.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/bat/bat1.gif")));
       conversador3.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/bat/bat2.gif")));
       conversador3.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/bat/bat3.gif")));
       conversador3.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/bat/bat4.gif")));
       ...
       Conversador conversador5 = new Conversador(0,bat5,null);
       conversador5.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/bat/bat1.gif")));
       conversador5.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/bat/bat2.gif")));
       conversador5.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/bat/bat3.gif")));
       conversador5.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/bat/bat4.gif")));
       
       Conversador conversador6 = new Conversador(0,bat6,null);
       conversador6.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/bat/bat1.gif")));
       conversador6.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/bat/bat2.gif")));
       conversador6.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/bat/bat3.gif")));
       conversador6.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/bat/bat4.gif")));
       
       Conversador conversador7 = new Conversador(0,bat7,null);
       conversador7.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/bat/bat1.gif")));
       conversador7.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/bat/bat2.gif")));
       conversador7.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/bat/bat3.gif")));
       conversador7.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/bat/bat4.gif")));
       
       Conversador conversador8 = new Conversador(0,bat8,null);
       conversador8.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/bat/bat1.gif")));
       conversador8.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/bat/bat2.gif")));
       conversador8.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/bat/bat3.gif")));
       conversador8.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/bat/bat4.gif")));
       ...
       JLabel o = obstaculo18;  //Obstaculo que delimita a los enemigos, no a Tahi. 
       ...
       enemigos.add(new Enemigo(this, conversador8,d,desplazamiento,obsAba,obsArr,obsIzq,obsDer,SPEED,70,tahi));
                ...
                case (KeyEvent.VK_DOWN): if(!desplazamiento.obstaculoAba(tahi, obstaculosAbajo) && !d.isVentanaAbierta())//Se valida si hay obstaculo
                                         {
                                            ...
                                            //espadazo.setLocation(espadazo.getX(),espadazo.getY()+SPEED);
                                         }
                ...
                case (KeyEvent.VK_RIGHT): if(!desplazamiento.obstaculoDer(tahi, obstaculosDerecha) && !d.isVentanaAbierta())//Se valida si hay obstaculo
                                          {
                                            ...
                                            //espadazo.setLocation(espadazo.getX()+SPEED,espadazo.getY());
                                          }  
                ...
                case (KeyEvent.VK_ENTER): if( !d.isVentanaAbierta() )
                                          {
                                             ...
                                             //if(dialogo.validarPosicionConversadora(posActual, cuadroActual, conversadores, d,
                                             //        RADIO, HIDDEN))
                                             { 
                                                d.setVentanaAbierta(true); 
                                             }
