 ...
 * @author Jacc89
 */
public final class Ventana02_s1 extends javax.swing.JFrame {
    ...
    public Ventana02_s1() {
        ...
        this.addKeyListener(new Ventana02_s1.AL());//ActionListener para el movimiento del personaje
        
        //barra.add(Tablero.getInstance());
    }
    ...
    private void initComponents() {
        ...
        objeto1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/arbol2.png"))); // NOI18N
        objeto1.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        getContentPane().add(objeto1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 172, 190, 126));
        objeto1.getAccessibleContext().setAccessibleName("objeto1");
        ...
        getContentPane().add(bat1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 180, -1, -1));
        ...
        getContentPane().add(bat2, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 280, -1, -1));
        ...
        getContentPane().add(bat3, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 360, -1, -1));

        tahi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/personajes/tahi/tahi2.png"))); // NOI18N
        getContentPane().add(tahi, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 360, -1, -1));
        ...
        getContentPane().add(cerca, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 270, -1, 80));
        getContentPane().add(obstaculo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 357, 227, 133));
        getContentPane().add(obstaculo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(327, 415, 473, 74));

        obstaculo3.setBackground(new java.awt.Color(0, 102, 0));
        getContentPane().add(obstaculo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(477, 90, 110, 100));

        obstaculo4.setBackground(new java.awt.Color(0, 102, 0));
        getContentPane().add(obstaculo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(538, 180, 40, 50));

        obstaculo5.setBackground(new java.awt.Color(0, 102, 0));
        getContentPane().add(obstaculo5, new org.netbeans.lib.awtextra.AbsoluteConstraints(731, 260, 70, 27));

        obstaculo6.setBackground(new java.awt.Color(0, 102, 0));
        getContentPane().add(obstaculo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(598, 280, 56, 70));

        obstaculo7.setBackground(new java.awt.Color(0, 102, 0));
        getContentPane().add(obstaculo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 60, 250, 70));
        getContentPane().add(obstaculo8, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 180, 134, 94));
        getContentPane().add(obstaculo9, new org.netbeans.lib.awtextra.AbsoluteConstraints(114, 140, 50, 50));
        getContentPane().add(obstaculo10, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 110, 100, 50));
        getContentPane().add(obstaculo11, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 384, 37, 60));
        getContentPane().add(obstaculo12, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 290, 27, 10));
        getContentPane().add(obstaculo13, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 70, 630, 350));

        obstaculo14.setBackground(new java.awt.Color(0, 102, 0));
        getContentPane().add(obstaculo14, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 230, 238, 92));
        getContentPane().add(obstaculoCerca, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, 10, 100));

        flecha.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/flechaabajo.gif"))); // NOI18N
        getContentPane().add(flecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 440, 0, 0));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/escenarios/escenario1/v02.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana02_s1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Ventana02_s1().setVisible(true);
            }
        });
    }
    ...
    {        
       ...
       Conversacion conversacion0 = new Conversacion();                
       conversacion0.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[0,2]/conversador1/dialogo1/1.png"))); 
       conversaciones1.add(conversacion0);
       ...
       //Se agregan los diferentes dialogos o movimientos de conversador 2 (murcielago).
       ...
       //Se agregan los diferentes dialogos o movimientos de conversador 3 (murcielago).
       ...
       JLabel o = obstaculo13;  //Obstaculo que delimita a los enemigos, no a Tahi. 
    ...
    {        
        ...
        public void keyPressed(KeyEvent e)
        {
            ...
            if (GestorJuego.getInstance().getMsnApertura()[1] && !cercaRetirada)
            {
                cerca.setSize(0,0);
            ...
            if(!mensajeMostrado && !GestorJuego.getInstance().getMsnApertura()[1])
            {
               mensajeApertura();
