 ...
 * @author Jacc89
 */
public final class Ventana12_s1 extends javax.swing.JFrame {
    ...
    private boolean bloquearMensajeApertura = false;
    ...
    public Ventana12_s1() {
        ...
        this.addKeyListener(new Ventana12_s1.AL());//ActionListener para el movimiento del personaje
    }
    ...
    private void initComponents() {
        ...
        flecha2.setForeground(new java.awt.Color(255, 255, 51));
        ...
        getContentPane().add(flecha2, new org.netbeans.lib.awtextra.AbsoluteConstraints(615, 100, 0, 0));
        ...
        getContentPane().add(ave1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 240, -1, -1));

        ave2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/personajes/ave/ave1.gif"))); // NOI18N
        getContentPane().add(ave2, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 120, -1, -1));

        ave3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/personajes/ave/ave1.gif"))); // NOI18N
        getContentPane().add(ave3, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 320, -1, -1));

        ave4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/personajes/ave/ave1.gif"))); // NOI18N
        getContentPane().add(ave4, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 120, -1, -1));
        ...
        getContentPane().add(tahi, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 0, -1, -1));
        tahi.getAccessibleContext().setAccessibleName("tahi");

        getContentPane().add(obstaculo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(327, 0, 460, 86));
        getContentPane().add(obstaculo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(676, 80, 90, 260));
        getContentPane().add(obstaculo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(662, 140, 20, 71));
        getContentPane().add(obstaculo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(638, 142, 20, 27));
        getContentPane().add(obstaculo5, new org.netbeans.lib.awtextra.AbsoluteConstraints(522, 220, 40, 20));
        getContentPane().add(obstaculo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(646, 325, 50, 50));
        getContentPane().add(obstaculo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(614, 358, 50, 50));
        getContentPane().add(obstaculo8, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 391, 280, 50));
        getContentPane().add(obstaculo9, new org.netbeans.lib.awtextra.AbsoluteConstraints(298, 358, 50, 50));
        getContentPane().add(obstaculo10, new org.netbeans.lib.awtextra.AbsoluteConstraints(162, 322, 150, 40));
        getContentPane().add(obstaculo11, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 270, 10, 60));
        getContentPane().add(obstaculo12, new org.netbeans.lib.awtextra.AbsoluteConstraints(73, 195, 150, 75));
        getContentPane().add(obstaculo13, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 150, 50, 50));
        getContentPane().add(obstaculo14, new org.netbeans.lib.awtextra.AbsoluteConstraints(96, 70, 100, 90));
        getContentPane().add(obstaculo15, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 20, 20, 60));
        getContentPane().add(obstaculo16, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 0, 67, 30));
        getContentPane().add(obstaculo17, new org.netbeans.lib.awtextra.AbsoluteConstraints(474, 287, 16, 10));
        getContentPane().add(obstaculo18, new org.netbeans.lib.awtextra.AbsoluteConstraints(64, 27, 670, 380));
        getContentPane().add(hermitano, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 140, 20, 30));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/escenarios/escenario1/v12.png"))); // NOI18N
        getContentPane().add(fondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));

        ave5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/personajes/ave/ave1.gif"))); // NOI18N
        getContentPane().add(ave5, new org.netbeans.lib.awtextra.AbsoluteConstraints(492, 120, -1, -1));

        ave6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/personajes/ave/ave1.gif"))); // NOI18N
        getContentPane().add(ave6, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 232, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana12_s1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Ventana12_s1().setVisible(true);
            }
        });
    }
    ...
    private void cargarPersonajes() {
      ...
      dialogo1.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[1,2]/conversador1/dialogo1/1.png")));      
      dialogo1.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[1,2]/conversador1/dialogo1/2.png")));
      ...
      ArrayList<Conversacion>conversaciones2 = new ArrayList<>();
        ...
        dialogo2.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[1,2]/conversador2/dialogo1/1.png")));      
        dialogo2.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[1,2]/conversador2/dialogo1/2.png")));
        dialogo2.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[1,2]/conversador2/dialogo1/3.png")));      
        dialogo2.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[1,2]/conversador2/dialogo1/4.png")));
        dialogo2.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[1,2]/conversador2/dialogo1/5.png")));                      
        dialogo2.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[1,2]/conversador2/dialogo2/1.png")));      
        dialogo2.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[1,2]/conversador2/dialogo2/2.png")));
        dialogo2.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[1,2]/conversador2/dialogo2/3.png")));                   
        dialogo2.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[1,2]/conversador2/dialogo3/1.png")));
        
        Conversacion dialogo5 = new Conversacion();                
        dialogo5.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[1,2]/conversador2/dialogo4/1.png")));
        dialogo5.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[1,2]/conversador2/dialogo4/2.png")));
        
        Conversacion dialogo6 = new Conversacion();                
        dialogo6.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[1,2]/conversador2/dialogo5/1.png")));
      
      if(!GestorJuego.getInstance().getRecursos()[2] && !GestorJuego.getInstance().getRecursos()[0])
      {
      ...
      //Se agregan los diferentes dveialogos o movimientos de conversador 2 (ave).
               
       Conversador conversador4 = new Conversador(0,ave2,null);
       conversador4.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/ave/ave1.gif")));
       conversador4.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/ave/ave2.gif")));
       conversador4.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/ave/ave3.gif")));
       conversador4.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/ave/ave4.gif")));
       
      //Se agregan los diferentes dveialogos o movimientos de conversador 3 (ave).
               
       Conversador conversador5 = new Conversador(0,ave3,null);
      ...
      //Se agregan los diferentes dveialogos o movimientos de conversador 4 (ave).
               
       Conversador conversador6 = new Conversador(0,ave4,null);
      ...
      //Copia de las lista de obstaculos los cuales serán validados por los enemigos
       ...
       new Animal(this,conversador4,d,desplazamiento,obsAba,obsArr,obsIzq,obsDer,SPEED,70,tahi).start();
    ...
    {  
       //Ayuda.getInstance().setMensajeActual(6); 
       ...
       else
       {
         ...
         {
            if(cuadroDialogo.getIcon().toString().contains("conversador2/dialogo3/1.png")) 
            {                
              //System.out.println(Jugador.getInstance().getRecursos()[4]);  
              if(GestorJuego.getInstance().getRecursos()[3]){//Se pregunta si el personaje tiene el agua.                
                 c.setDialogoActual(c.getDialogoActual()+1);                 
              }          
            }
            else if(cuadroDialogo.getIcon().toString().contains("conversador2/dialogo4/3.png"))
            {
                //GestorJuego.getInstance().agregarRecurso(3);
                //GestorJuego.getInstance().quitarRecurso(4); //Se le quita al personaje el agua.
                c.setDialogoActual(c.getDialogoActual()+1);
                //System.out.println(Ayuda.getInstance().getMensajeActual());
                //Ayuda.getInstance().setMensajeActual(9);
                //System.out.println(Ayuda.getInstance().getMensajeActual());
            }
            else{
              c.setDialogoActual(c.getDialogoActual()+1);
    ...
    {    
        ...
        public void keyPressed(KeyEvent e)
        {
            ...
            if(!GestorJuego.getInstance().getMsnApertura()[2] && !bloquearMensajeApertura)
            {
              mensajeApertura();
              //GestorJuego.getInstance().getMsnApertura()[2] = true;
              bloquearMensajeApertura = true;
            }
        ...
        public void casosEspeciales()
        {
          if(cuadroDialogo.getIcon().toString().contains("conversador2/dialogo3/1.png"))
          {
              GestorJuego.getInstance().getMsnApertura()[1] = true;
              GestorJuego.getInstance().getMsnApertura()[2] = true;
              //GestorJuego.getInstance().getMsnApertura()[3] = true;
              
              if(!GestorJuego.getInstance().getRecursos()[3])
              {
                Ayuda.getInstance().resaltarTeclaAyuda(true);
              }
          }  
          else if(cuadroDialogo.getIcon().toString().contains("conversador2/dialogo4/2.png"))
          {
              GestorJuego.getInstance().agregarRecurso(3);              
              Ayuda.getInstance().resaltarTeclaAyuda(true);                          
              GestorJuego.getInstance().quitarRecurso(4); //Se le quita al personaje el agua.
