 ...
 * @author Jacc89
 */
public final class Ventana18_s1 extends javax.swing.JFrame {
    ...
    public Ventana18_s1() {
        ...
        this.addKeyListener(new Ventana18_s1.AL());//ActionListener para el movimiento del personaje   
    ...
    private void initComponents() {
        ...
        getContentPane().add(numPuntaje1, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 413, 14, 29));
        ...
        getContentPane().add(numPuntaje2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 413, 14, 29));
        ...
        getContentPane().add(numPuntaje3, new org.netbeans.lib.awtextra.AbsoluteConstraints(45, 413, 14, 29));
        ...
        getContentPane().add(numPuntaje4, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 413, 14, 29));
        ...
        getContentPane().add(marcoPuntaje, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 410, 70, 35));
        ...
        getContentPane().add(puntaje, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 390, -1, -1));
        ...
        getContentPane().add(fuente1, new org.netbeans.lib.awtextra.AbsoluteConstraints(242, 118, 0, 0));

        fuente2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/fuente.gif"))); // NOI18N
        getContentPane().add(fuente2, new org.netbeans.lib.awtextra.AbsoluteConstraints(429, 118, 0, 0));
        ...
        getContentPane().add(cascada1, new org.netbeans.lib.awtextra.AbsoluteConstraints(167, 450, 121, 88));
        ...
        getContentPane().add(cascada2, new org.netbeans.lib.awtextra.AbsoluteConstraints(283, 450, 121, 88));
        ...
        getContentPane().add(cascada3, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 450, 121, 88));
        ...
        getContentPane().add(cascada4, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 450, 121, 88));

        objeto1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/columnas2.png"))); // NOI18N
        getContentPane().add(objeto1, new org.netbeans.lib.awtextra.AbsoluteConstraints(324, 67, -1, -1));

        objeto2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/columna2.png"))); // NOI18N
        getContentPane().add(objeto2, new org.netbeans.lib.awtextra.AbsoluteConstraints(291, 89, -1, -1));

        objeto3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/columna2.png"))); // NOI18N
        getContentPane().add(objeto3, new org.netbeans.lib.awtextra.AbsoluteConstraints(515, 89, -1, -1));

        objeto4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/arbol6.png"))); // NOI18N
        getContentPane().add(objeto4, new org.netbeans.lib.awtextra.AbsoluteConstraints(-57, -45, -1, -1));

        objeto6.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        objeto6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/arbol6.png"))); // NOI18N
        getContentPane().add(objeto6, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, -120, 65, -1));

        objeto5.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        objeto5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/arbol6.png"))); // NOI18N
        getContentPane().add(objeto5, new org.netbeans.lib.awtextra.AbsoluteConstraints(733, -42, 65, -1));
        ...
        getContentPane().add(tahi, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 450, -1, -1));
        tahi.getAccessibleContext().setAccessibleName("tahi");

        puerta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/puerta.png"))); // NOI18N
        getContentPane().add(puerta, new org.netbeans.lib.awtextra.AbsoluteConstraints(353, 76, -1, -1));
        ...
        getContentPane().add(troncoTiempo, new org.netbeans.lib.awtextra.AbsoluteConstraints(422, 303, 70, -1));
        troncoTiempo.getAccessibleContext().setAccessibleName("troncoTiempo");

        getContentPane().add(obstaculo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 20, 150));
        getContentPane().add(obstaculo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 610, 30));
        getContentPane().add(obstaculo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 0, 10, 150));
        getContentPane().add(obstaculo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 0, 60, 20));
        getContentPane().add(obstaculo5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 132, 280, 120));
        getContentPane().add(obstaculo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 132, 240, 120));
        getContentPane().add(obstaculo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(258, 228, 120, 200));
        getContentPane().add(obstaculo8, new org.netbeans.lib.awtextra.AbsoluteConstraints(453, 225, 90, 140));
        getContentPane().add(obstaculo9, new org.netbeans.lib.awtextra.AbsoluteConstraints(485, 348, 0, 140));
        getContentPane().add(obstaculo10, new org.netbeans.lib.awtextra.AbsoluteConstraints(368, 420, 40, 70));
        getContentPane().add(obstaculo11, new org.netbeans.lib.awtextra.AbsoluteConstraints(288, 159, 60, 60));
        getContentPane().add(obstaculo12, new org.netbeans.lib.awtextra.AbsoluteConstraints(482, 157, 60, 60));
        getContentPane().add(obstaculo13, new org.netbeans.lib.awtextra.AbsoluteConstraints(287, 125, 60, 30));
        getContentPane().add(obstaculo14, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 125, 60, 30));
        getContentPane().add(obstaculoPuerta, new org.netbeans.lib.awtextra.AbsoluteConstraints(345, 130, 150, 0));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/escenarios/escenario1/v18.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana18_s1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Ventana18_s1().setVisible(true);
            }
        });
    }
    ...
    private void cargarObstaculos() {
        ...
        if(!GestorJuego.getInstance().getPuertas()[4]){this.obstaculos.add(this.obstaculoPuerta);}
    ...
    public int validarPosFuente()
    {
       int numFuente = 0;
       
       if(tahi.getX()<obstaculo11.getX()+obstaculo11.getWidth()+10
          && tahi.getY() >= obstaculo11.getY() && tahi.getY() <= obstaculo11.getY()+obstaculo11.getHeight())
       {
          numFuente = 1; 
       }
       else if(tahi.getX()+tahi.getWidth()>obstaculo12.getX()-10
               && tahi.getY() >= obstaculo12.getY() && tahi.getY() <= obstaculo12.getY()+obstaculo12.getHeight())
       {
          numFuente = 2;
       }
    ...
    public void activarFuente(int numFuente, boolean quitar)
    {
       if(numFuente == 1)
       {
          fuente1.setSize(fuente1.getPreferredSize()); //Se activa la fuente 1   
          f1 = true;
          Sonidos.getInstance().reproducir("success2");
       }
       else if(numFuente == 2)
       {
          fuente2.setSize(fuente2.getPreferredSize()); //Se activa la fuente 2
          f2 = true;
          Sonidos.getInstance().reproducir("success2");
       } 
       
       if(quitar){GestorJuego.getInstance().quitarRecurso(4);}//Se le quita al jugador el recurso 4 (agua).
       
       if(f1 && f2)
       {
          GestorJuego.getInstance().abrirPuerta(4); 
          obstaculosArriba.quitarObstaculo(obstaculoPuerta, obstaculosArriba, obstaculosAbajo, obstaculosDerecha, obstaculosIzquierda, SPEED); //se abre la rejilla! 
          puerta.setSize(0,0);
       }
    }
    ...
    {       
        ...
        public void keyPressed(KeyEvent e)
        {
            ...
            if(i == 0)
            {
              ...
              if(f1){activarFuente(1,false);}
              if(f2){activarFuente(2,false);}
              if(GestorJuego.getInstance().getPuertas()[4]){activarFuente(1,false);activarFuente(2,false);}
              i++;
            }        
            switch(keyCode)
            {
                ...
                case (KeyEvent.VK_ENTER): if( !d.isVentanaAbierta() )
                                          {
                                             ...
                                             {
                                                int numFuente = validarPosFuente(); //Activacion de fuentes si se esta en una ubicacion cercana.
                                                if(numFuente != 0 && GestorJuego.getInstance().getRecursos()[3])
                                                {                                                    
                                                   activarFuente(numFuente,true); 
                                                }
                                             }                                             
                                          }
                                          else
