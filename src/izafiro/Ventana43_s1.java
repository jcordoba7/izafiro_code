 ...
 * @author Jacc89
 */
public final class Ventana43_s1 extends javax.swing.JFrame {
    ...
    public Ventana43_s1() {
        ...
        this.addKeyListener(new Ventana43_s1.AL());//ActionListener para el movimiento del personaje   
    ...
    private void initComponents() {
        ...
        getContentPane().add(fuente1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 160, -1, -1));

        fuente2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/fuente.gif"))); // NOI18N
        getContentPane().add(fuente2, new org.netbeans.lib.awtextra.AbsoluteConstraints(535, 160, -1, -1));

        fuente3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/fuente.gif"))); // NOI18N
        getContentPane().add(fuente3, new org.netbeans.lib.awtextra.AbsoluteConstraints(202, 160, -1, -1));

        fuente4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/fuente.gif"))); // NOI18N
        getContentPane().add(fuente4, new org.netbeans.lib.awtextra.AbsoluteConstraints(453, 160, -1, -1));
        ...
        getContentPane().add(soldado2, new org.netbeans.lib.awtextra.AbsoluteConstraints(705, 340, -1, -1));
        ...
        getContentPane().add(soldado1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 95, -1, -1));
        ...
        getContentPane().add(obstaculo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(123, 140, 230, 170));
        getContentPane().add(obstaculo8, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 140, 240, 170));
        getContentPane().add(obstaculo9, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 45, 50, 5));
        getContentPane().add(obstaculo10, new org.netbeans.lib.awtextra.AbsoluteConstraints(432, 423, 350, 0));
        getContentPane().add(obstaculo11, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 423, 350, 0));
        getContentPane().add(obstaculo12, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 440, 348, 50));
        getContentPane().add(obstaculo13, new org.netbeans.lib.awtextra.AbsoluteConstraints(458, 440, 340, 50));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/escenarios/escenario1/v43.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana43_s1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Ventana43_s1().setVisible(true);
            }
        });
    }
    ...
    {       
        ...
        public void keyPressed(KeyEvent e)
        {
            ...
            if(senal.i == 0)
            {
              ...
              puntos [0] = new Point(70,95);
              puntos [1] = new Point(390,95);
              puntos [2] = new Point(390,340);
              puntos [3] = new Point(70,340);
              
              int[] vec = new int[3];
              vec[0] = 4; vec[1] = 3;
             
              soldados.add(new Soldado(soldado1,tahi,puntos,55,0,obstaculosAbajo,obstaculosArriba,obstaculosIzquierda,obstaculosDerecha,0,vec,senal,clip1,soldados,10));
              
              // ------ soldado2 ----------
             
              Point[] puntos2 = new Point[4];
              puntos2 [0] = new Point(390,95);
              puntos2 [1] = new Point(705,95);
              puntos2 [2] = new Point(705,340);
              puntos2 [3] = new Point(390,340);
              
              soldados.add(new Soldado(soldado2,tahi,puntos2,55,1,obstaculosAbajo,obstaculosArriba,obstaculosIzquierda,obstaculosDerecha,0,vec,senal,clip1,soldados,10));
            ...
            switch(keyCode)
            {
                case (KeyEvent.VK_DOWN): if(!desplazamiento.obstaculoAba(tahi, obstaculosAbajo) && !d.isVentanaAbierta())//Se valida si hay obstaculo
                                         ...
                                         if(tahi.getY() > fondo.getHeight()-5)  //Se valida si tahi sale de la ventana
                                         {
                                            ...
                                            Sonidos.getInstance().detener(clip1);;senal.i=0;
                                         }
                                         break;
