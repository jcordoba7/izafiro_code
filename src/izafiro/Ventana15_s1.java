 ...
 * @author Jacc89
 */
public final class Ventana15_s1 extends javax.swing.JFrame {
    ...
    public Ventana15_s1() {
        ...
        this.addKeyListener(new Ventana15_s1.AL());//ActionListener para el movimiento del personaje   
    ...
    private void initComponents() {
        ...
        getContentPane().add(roca1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 360, -1, -1));

        roca3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/rocaaba.gif"))); // NOI18N
        getContentPane().add(roca3, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 120, -1, -1));

        objeto1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/arbol7.png"))); // NOI18N
        objeto1.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        getContentPane().add(objeto1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-30, 250, -1, -1));
        ...
        getContentPane().add(spider1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 240, -1, -1));
        ...
        getContentPane().add(spider2, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 280, -1, -1));
        ...
        getContentPane().add(puente1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 225, -1, -1));

        puente2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/puente6.png"))); // NOI18N
        getContentPane().add(puente2, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 225, -1, -1));

        interruptor2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/interruptoroff.png"))); // NOI18N
        getContentPane().add(interruptor2, new org.netbeans.lib.awtextra.AbsoluteConstraints(675, 73, -1, -1));

        interruptor1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/interruptoroff.png"))); // NOI18N
        getContentPane().add(interruptor1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 73, -1, -1));
        ...
        cerca.setPreferredSize(new java.awt.Dimension(50, 110));
        getContentPane().add(cerca, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 200, -1, -1));
        getContentPane().add(obstaculo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 380, 100, 50));
        getContentPane().add(obstaculo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(174, 50, 80, 180));
        getContentPane().add(obstaculo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 0, 340, 140));
        getContentPane().add(obstaculo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 800, 100));
        getContentPane().add(obstaculo5, new org.netbeans.lib.awtextra.AbsoluteConstraints(244, 415, 360, 20));
        getContentPane().add(obstaculo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 352, 85, 90));
        getContentPane().add(obstaculo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(174, 310, 80, 130));
        getContentPane().add(obstaculo8, new org.netbeans.lib.awtextra.AbsoluteConstraints(158, 310, 110, 0));
        getContentPane().add(obstaculo9, new org.netbeans.lib.awtextra.AbsoluteConstraints(158, 231, 110, 0));
        getContentPane().add(obstaculo10, new org.netbeans.lib.awtextra.AbsoluteConstraints(568, 231, 110, -1));
        getContentPane().add(obstaculo11, new org.netbeans.lib.awtextra.AbsoluteConstraints(743, 310, 56, 170));
        getContentPane().add(obstaculo12, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 310, 110, 0));
        getContentPane().add(obstaculo13, new org.netbeans.lib.awtextra.AbsoluteConstraints(657, 392, 90, 30));
        getContentPane().add(obstaculo14, new org.netbeans.lib.awtextra.AbsoluteConstraints(592, 90, 70, 130));
        getContentPane().add(obstaculo15, new org.netbeans.lib.awtextra.AbsoluteConstraints(592, 320, 70, 120));
        getContentPane().add(obstaculo16, new org.netbeans.lib.awtextra.AbsoluteConstraints(753, 60, 46, 135));
        getContentPane().add(obstaculo17, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 28, 20, 110));
        getContentPane().add(obstaculo18, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 198, 240, 170));
        getContentPane().add(obstaculoCerca, new org.netbeans.lib.awtextra.AbsoluteConstraints(783, 208, -1, 100));
        getContentPane().add(obstaculoPuente1, new org.netbeans.lib.awtextra.AbsoluteConstraints(174, 220, 80, 140));
        getContentPane().add(obstaculoPuente2, new org.netbeans.lib.awtextra.AbsoluteConstraints(592, 220, 70, 130));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/escenarios/escenario1/v15.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana15_s1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Ventana15_s1().setVisible(true);
            }
        });
    }
    ...
    private void cargarPersonajes() {
       ...
       new Rodante(this,tahi,"vertical",120,360,roca1,i1,i2,3,40,5,10).start();
       new Rodante(this,tahi,"vertical",120,360,roca3,i1,i2,3,40,5,10).start();
       
       Conversador conversador1 = new Conversador(0,spider1,null);
       ...
       Conversador conversador2 = new Conversador(0,spider2,null);
       conversador2.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/spider/spider1.gif")));
       conversador2.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/spider/spider2.gif")));
       conversador2.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/spider/spider3.gif")));
       conversador2.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/spider/spider4.gif")));
    ...
    {       
        ...
        public void keyPressed(KeyEvent e)
        {
            ...
            if(i==0)
            {
              Sonidos.getInstance().reproducirLoop(clip1);i++;
            ...
            switch(keyCode)
            {
                ...
                case (KeyEvent.VK_SPACE): if(GestorJuego.getInstance().getRecursos()[0]){new Espadazo(enemigos,espadazo,tahi).start();} 
                                          if(!interruptorActivado)
                                          {
                                            ...
                                            {
                                              new HiloPuente(interruptor1).start();
                                            }
                                            else if(desplazamiento.contiene(interruptor2, tahi.getLocation()))
                                            {
                                              new HiloPuente(interruptor2).start();  
                                            }
                                          }
                                          break;
                ...
                case (KeyEvent.VK_ENTER): if( !d.isVentanaAbierta() )
                                          {
                                             ...
                                             {
                                                d.setVentanaAbierta(true); 
                                                new Puzzle0(5,sv,cerca,obstaculoCerca, obstaculosAbajo, obstaculosIzquierda, obstaculosDerecha, obstaculosArriba,d).setVisible(true); 
                                             }
                                          }
                                          else
                                          {
