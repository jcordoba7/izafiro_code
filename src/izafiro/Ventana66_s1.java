 ...
 * @author Jacc89
 */
public final class Ventana66_s1 extends javax.swing.JFrame {
    ...
    public Ventana66_s1() {
        ...
        this.addKeyListener(new Ventana66_s1.AL());//ActionListener para el movimiento del personaje   
    ...
    private void initComponents() {
        ...
        caja5 = new javax.swing.JLabel();
        caja6 = new javax.swing.JLabel();
        ...
        getContentPane().add(tahi, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 270, -1, -1));
        ...
        getContentPane().add(caja1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 200, -1, -1));

        caja2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/caja.png"))); // NOI18N
        getContentPane().add(caja2, new org.netbeans.lib.awtextra.AbsoluteConstraints(471, 200, -1, -1));

        caja3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/caja.png"))); // NOI18N
        getContentPane().add(caja3, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 240, -1, -1));

        caja4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/caja.png"))); // NOI18N
        getContentPane().add(caja4, new org.netbeans.lib.awtextra.AbsoluteConstraints(603, 170, -1, -1));

        caja5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/caja.png"))); // NOI18N
        getContentPane().add(caja5, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 310, -1, -1));

        caja6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/caja.png"))); // NOI18N
        getContentPane().add(caja6, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 275, -1, -1));

        cerca.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/cerca2.png"))); // NOI18N
        cerca.setPreferredSize(new java.awt.Dimension(90, 32));
        getContentPane().add(cerca, new org.netbeans.lib.awtextra.AbsoluteConstraints(396, 74, 0, 0));
        getContentPane().add(punto1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 100, 20, 20));
        getContentPane().add(punto2, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 100, 20, 20));
        getContentPane().add(punto3, new org.netbeans.lib.awtextra.AbsoluteConstraints(595, 100, 20, 20));
        getContentPane().add(punto4, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 100, 20, 20));
        getContentPane().add(punto5, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 230, 20, 20));
        getContentPane().add(punto6, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 230, 20, 20));
        getContentPane().add(obstaculo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 397, 800, 190));
        getContentPane().add(obstaculo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 0, 310, 108));
        getContentPane().add(obstaculo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 90, 175));
        getContentPane().add(obstaculo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(775, 0, 20, 410));
        getContentPane().add(obstaculo5, new org.netbeans.lib.awtextra.AbsoluteConstraints(337, 237, 32, 33));
        getContentPane().add(obstaculo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(708, 107, 64, 32));
        getContentPane().add(obstaculo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(496, 107, 64, 32));
        getContentPane().add(obstaculo9, new org.netbeans.lib.awtextra.AbsoluteConstraints(672, 163, 64, 32));
        getContentPane().add(obstaculo10, new org.netbeans.lib.awtextra.AbsoluteConstraints(672, 304, 64, 28));
        getContentPane().add(obstaculo11, new org.netbeans.lib.awtextra.AbsoluteConstraints(149, 304, 64, 28));
        getContentPane().add(obstaculo13, new org.netbeans.lib.awtextra.AbsoluteConstraints(321, 107, 64, 32));
        getContentPane().add(obstaculo14, new org.netbeans.lib.awtextra.AbsoluteConstraints(109, 107, 64, 32));
        getContentPane().add(obstaculo15, new org.netbeans.lib.awtextra.AbsoluteConstraints(339, 272, 198, 33));
        getContentPane().add(obstaculo16, new org.netbeans.lib.awtextra.AbsoluteConstraints(284, 347, 64, 32));
        getContentPane().add(obstaculo17, new org.netbeans.lib.awtextra.AbsoluteConstraints(536, 344, 64, 32));
        getContentPane().add(obstaculo18, new org.netbeans.lib.awtextra.AbsoluteConstraints(509, 238, 31, 32));
        getContentPane().add(obstaculo19, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 0, 300, 108));

        obstaculo20.setBackground(new java.awt.Color(102, 51, 0));
        getContentPane().add(obstaculo20, new org.netbeans.lib.awtextra.AbsoluteConstraints(407, 200, 61, 32));
        getContentPane().add(obstaculoCerca, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 80, 120, 0));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/escenarios/escenario1/v66.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana66_s1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Ventana66_s1().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel caja5;
    private javax.swing.JLabel caja6;
    ...
    private javax.swing.JLabel punto6;
    ...
    private void cargarObstaculos() {
        ...
        if(!GestorJuego.getInstance().getPuertas()[7]){this.obstaculos.add(this.obstaculoCerca);}
    ...
    public void validarDesactivacion()
    {
        ...
        GestorJuego.getInstance().abrirPuerta(7);
    ...
    public class AL extends KeyAdapter
    {
        ...
        public void keyPressed(KeyEvent e)
        {
            ...
            if(i==0)
            {
               if(!GestorJuego.getInstance().getPuertas()[7]){cerca.setSize(cerca.getPreferredSize());}
               for(int j =0; j<cajas.length; j++){actualizarObstaculos(cajas[j]);}                             
               i++;
            }
            
            if(avisoAyuda == 0 && !GestorJuego.getInstance().getPuertas()[7])
            {
