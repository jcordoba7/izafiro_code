 ...
 * @author Jacc89
 */
public final class Ventana29_s1 extends javax.swing.JFrame {
    ...
    public Ventana29_s1() {
        ...
        this.addKeyListener(new Ventana29_s1.AL());//ActionListener para el movimiento del personaje   
    ...
    private void initComponents() {
        ...
        getContentPane().add(numPuntaje1, new org.netbeans.lib.awtextra.AbsoluteConstraints(725, 444, 14, 29));
        ...
        getContentPane().add(numPuntaje2, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 444, 14, 29));
        ...
        getContentPane().add(numPuntaje3, new org.netbeans.lib.awtextra.AbsoluteConstraints(755, 444, 14, 29));
        ...
        getContentPane().add(numPuntaje4, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 444, 14, 29));
        ...
        getContentPane().add(puntaje, new org.netbeans.lib.awtextra.AbsoluteConstraints(728, 420, -1, -1));
        ...
        objeto1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/arbol9.png"))); // NOI18N
        objeto1.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        getContentPane().add(objeto1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 0, -1, 130));

        objeto2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/arbol9.png"))); // NOI18N
        getContentPane().add(objeto2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 160, -1, -1));

        objeto3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/arbol9.png"))); // NOI18N
        getContentPane().add(objeto3, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 10, -1, -1));
        ...
        getContentPane().add(lobo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 280, -1, -1));
        ...
        getContentPane().add(lobo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 220, -1, -1));
        ...
        getContentPane().add(cascada1, new org.netbeans.lib.awtextra.AbsoluteConstraints(157, 455, 121, 88));
        ...
        getContentPane().add(cascada2, new org.netbeans.lib.awtextra.AbsoluteConstraints(283, -60, 121, 88));
        ...
        getContentPane().add(cascada3, new org.netbeans.lib.awtextra.AbsoluteConstraints(584, -60, 121, 88));
        ...
        getContentPane().add(cascada4, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, -60, 121, 88));
        ...
        getContentPane().add(cascada5, new org.netbeans.lib.awtextra.AbsoluteConstraints(167, -60, 121, 88));
        ...
        getContentPane().add(cascada6, new org.netbeans.lib.awtextra.AbsoluteConstraints(281, 455, 121, 88));
        ...
        getContentPane().add(cascada7, new org.netbeans.lib.awtextra.AbsoluteConstraints(496, 455, 121, 88));
        ...
        getContentPane().add(cascada8, new org.netbeans.lib.awtextra.AbsoluteConstraints(738, 455, 61, 88));
        ...
        getContentPane().add(cascada9, new org.netbeans.lib.awtextra.AbsoluteConstraints(617, 455, 121, 88));

        roca1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/rocader.gif"))); // NOI18N
        getContentPane().add(roca1, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 340, -1, -1));
        ...
        cerca.setPreferredSize(new java.awt.Dimension(40, 32));
        getContentPane().add(cerca, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 260, 0, 0));

        tahi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/personajes/tahi/tahi2.png"))); // NOI18N
        getContentPane().add(tahi, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 240, -1, -1));
        ...
        getContentPane().add(troncoTiempo, new org.netbeans.lib.awtextra.AbsoluteConstraints(717, 150, 80, -1));
        troncoTiempo.getAccessibleContext().setAccessibleName("troncoTiempo");

        getContentPane().add(obstaculo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 260, 70, 200));
        getContentPane().add(obstaculo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 10, 290, 180));
        getContentPane().add(obstaculo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 10, 250, 180));
        getContentPane().add(obstaculo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 0, 170, 45));
        getContentPane().add(obstaculo5, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 98, 115, 123));
        getContentPane().add(obstaculo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 420, 300, 70));
        getContentPane().add(obstaculo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(775, 322, 20, 130));
        getContentPane().add(obstaculo8, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 322, 450, 30));
        getContentPane().add(obstaculo9, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 102, 215, 250));
        getContentPane().add(obstaculo10, new org.netbeans.lib.awtextra.AbsoluteConstraints(163, 420, 240, 70));
        getContentPane().add(obstaculo11, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 120, 50));
        getContentPane().add(obstaculo12, new org.netbeans.lib.awtextra.AbsoluteConstraints(456, 290, 180, 50));
        getContentPane().add(obstaculo13, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 453, 170, 140));
        getContentPane().add(obstaculo14, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 177, 20, 40));
        getContentPane().add(obstaculo15, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 155, -1, 200));
        getContentPane().add(obstaculo16, new org.netbeans.lib.awtextra.AbsoluteConstraints(77, 30, 100, 44));
        getContentPane().add(obstaculo17, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 30, 188));
        getContentPane().add(obstaculo18, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 315, 30, 270));
        getContentPane().add(obstaculo19, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 452, 100, 30));
        getContentPane().add(obstaculo20, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 190, 200, 160));

        obstaculoCerca.setPreferredSize(new java.awt.Dimension(40, 32));
        getContentPane().add(obstaculoCerca, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 280, -1, 0));
        getContentPane().add(agua, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 20, 50, 30));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/escenarios/escenario1/v29.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana29_s1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Ventana29_s1().setVisible(true);
            }
        });
    }
    ...
    private void cargarPersonajes() {
       ...
       new Rodante(this,tahi,"horizontal",720,210,roca1,i1,i2,3,45,10,5).start();
         
       
       Conversador conversador1 = new Conversador(0,lobo1,null);
       conversador1.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/lobo/lobo1.gif")));
       conversador1.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/lobo/lobo2.gif")));
       conversador1.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/lobo/lobo3.gif")));
       conversador1.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/lobo/lobo4.gif")));
       
       Conversador conversador2 = new Conversador(0,lobo2,null);
       conversador2.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/lobo/lobo1.gif")));
       conversador2.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/lobo/lobo2.gif")));
       conversador2.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/lobo/lobo3.gif")));
       conversador2.getPosiciones().add(new ImageIcon(getClass().getResource("imagenes/personajes/lobo/lobo4.gif"))); 
       ...
       dialogo1.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[2,9]/conversador1/dialogo1/1.png")));
      
       Conversacion dialogo2 = new Conversacion();                
       dialogo2.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[2,9]/conversador1/dialogo2/1.png")));
      
       conversaciones1.add(dialogo1);
       conversaciones1.add(dialogo2);
      
       Conversador conversador3 = new Conversador(0,cerca,conversaciones1);
       
       
       //Se agregan los diferentes dialogos de conversador 1 (agua).
      
       ArrayList<Conversacion>conversaciones2 = new ArrayList<>();
       
       Conversacion dialogo3 = new Conversacion();                
       dialogo3.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[2,9]/conversador2/dialogo2/1.png")));
        
       Conversacion dialogo4 = new Conversacion();                
       dialogo4.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[2,9]/conversador2/dialogo2/1.png")));
              
       conversaciones2.add(dialogo3);
       conversaciones2.add(dialogo4);
       
       
       Conversador conversador4 = new Conversador(0,agua,conversaciones2);
       ...
       JLabel o = obstaculo20;  //Obstaculo que delimita a los enemigos, no a Tahi. 
    ...
    private void cargarObstaculos() {
        ...
        if(!GestorJuego.getInstance().getPuertas()[3]){this.obstaculos.add(this.obstaculoCerca);}
    ...
    {  
       ...
       else
       {
         if(c.getDialogoActual() < c.getDialogos().size()-1)
         {
            ...
            else if(cuadroDialogo.getIcon().toString().contains("conversador2/dialogo2/1.png")) 
            {
              if(GestorJuego.getInstance().getRecursos()[1]){//Se pregunta si el personaje tiene la cantimplora.
                //GestorJuego.getInstance().agregarRecurso(4);
                c.setDialogoActual(c.getDialogoActual()+1);
              }  
            }            
            else{
       ...
       if(cuadroDialogo.getIcon().toString().contains("conversador1/dialogo2/1.png") && GestorJuego.getInstance().getRecursos()[2])
       {
           ...
           GestorJuego.getInstance().abrirPuerta(3);  
           cerca.setSize(0,0);
    ...
    {       
        ...
        public void keyPressed(KeyEvent e)
        {
            ...
            if(!GestorJuego.getInstance().getPuertas()[3]){cerca.setSize(cerca.getPreferredSize());}
        ...
        {
            if(cuadroDialogo.getIcon().toString().contains("conversador2/dialogo2/1.png")) 
            {
                GestorJuego.getInstance().agregarRecurso(4);
            }
        }
