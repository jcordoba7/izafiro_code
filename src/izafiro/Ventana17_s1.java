 ...
 * @author Jacc89
 */
public final class Ventana17_s1 extends javax.swing.JFrame {
    ...
    public Ventana17_s1() {
        ...
        this.addKeyListener(new Ventana17_s1.AL());//ActionListener para el movimiento del personaje   
    ...
    private void initComponents() {
        ...
        obstaculo29 = new javax.swing.JLabel();
        obstaculo30 = new javax.swing.JLabel();
        obstaculo31 = new javax.swing.JLabel();
        obstaculo32 = new javax.swing.JLabel();
        obstaculo33 = new javax.swing.JLabel();
        ...
        getContentPane().add(numPuntaje1, new org.netbeans.lib.awtextra.AbsoluteConstraints(345, 23, 14, 29));
        ...
        getContentPane().add(numPuntaje2, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 23, 14, 29));
        ...
        getContentPane().add(numPuntaje3, new org.netbeans.lib.awtextra.AbsoluteConstraints(375, 23, 14, 29));
        ...
        getContentPane().add(numPuntaje4, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 23, 14, 29));
        ...
        getContentPane().add(marcoPuntaje, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 20, 70, 35));
        ...
        getContentPane().add(sound, new org.netbeans.lib.awtextra.AbsoluteConstraints(615, 30, 0, 0));

        puntaje.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        puntaje.setForeground(new java.awt.Color(255, 255, 255));
        puntaje.setText("Puntaje");
        getContentPane().add(puntaje, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 0, -1, -1));

        titulo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/izafitotittlepequeno.png"))); // NOI18N
        getContentPane().add(titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 10, 0, 0));
        ...
        marco.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/marco2.png"))); // NOI18N
        marco.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        getContentPane().add(marco, new org.netbeans.lib.awtextra.AbsoluteConstraints(518, 0, -1, 100));

        sombra.setBackground(new java.awt.Color(0, 0, 0));
        sombra.setOpaque(true);
        getContentPane().add(sombra, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 30, 180, 30));
        ...
        getContentPane().add(tahi, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 280, -1, -1));
        ...
        getContentPane().add(caja1, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 231, -1, -1));
        caja1.getAccessibleContext().setAccessibleName("caja");

        cerca.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        cerca.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/cerca.png"))); // NOI18N
        cerca.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        cerca.setPreferredSize(new java.awt.Dimension(100, 50));
        getContentPane().add(cerca, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 420, 0, 0));

        interruptor2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/interruptoroff.png"))); // NOI18N
        getContentPane().add(interruptor2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 0, -1, -1));

        interruptor1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/interruptoroff.png"))); // NOI18N
        getContentPane().add(interruptor1, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 360, -1, -1));

        puente1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/caminover6.png"))); // NOI18N
        getContentPane().add(puente1, new org.netbeans.lib.awtextra.AbsoluteConstraints(19, 76, -1, -1));

        puente2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/caminohor6.png"))); // NOI18N
        getContentPane().add(puente2, new org.netbeans.lib.awtextra.AbsoluteConstraints(82, 268, -1, -1));

        puente3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/caminohor6.png"))); // NOI18N
        getContentPane().add(puente3, new org.netbeans.lib.awtextra.AbsoluteConstraints(641, 205, -1, -1));
        getContentPane().add(punto1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 110, 20, 20));
        getContentPane().add(obstaculo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 470, 595, 20));
        getContentPane().add(obstaculo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 0, 350, 118));
        getContentPane().add(obstaculo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 550, 20));
        getContentPane().add(obstaculo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(755, 0, 20, 490));
        getContentPane().add(obstaculo5, new org.netbeans.lib.awtextra.AbsoluteConstraints(425, 232, 32, 32));
        getContentPane().add(obstaculo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(682, 327, 90, 60));
        getContentPane().add(obstaculo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(426, 157, 210, 40));
        getContentPane().add(obstaculo8, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 408, 590, 17));
        getContentPane().add(obstaculo9, new org.netbeans.lib.awtextra.AbsoluteConstraints(596, 157, 100, 30));
        getContentPane().add(obstaculo10, new org.netbeans.lib.awtextra.AbsoluteConstraints(646, 262, 60, 125));
        getContentPane().add(obstaculo11, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 324, 40, 90));
        getContentPane().add(obstaculo12, new org.netbeans.lib.awtextra.AbsoluteConstraints(137, 335, 32, 32));
        getContentPane().add(obstaculo13, new org.netbeans.lib.awtextra.AbsoluteConstraints(77, 89, 57, 141));
        getContentPane().add(obstaculo14, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 20, 230));
        getContentPane().add(obstaculo15, new org.netbeans.lib.awtextra.AbsoluteConstraints(426, 5, 47, 180));
        getContentPane().add(obstaculo16, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 490, 750, -1));
        getContentPane().add(obstaculo17, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 465, 0, 20));
        getContentPane().add(obstaculo18, new org.netbeans.lib.awtextra.AbsoluteConstraints(133, 160, 31, 32));
        getContentPane().add(obstaculo19, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 119, 32, 32));
        getContentPane().add(obstaculo20, new org.netbeans.lib.awtextra.AbsoluteConstraints(369, 140, 32, 32));
        getContentPane().add(obstaculo21, new org.netbeans.lib.awtextra.AbsoluteConstraints(211, 230, 32, 32));
        getContentPane().add(obstaculo22, new org.netbeans.lib.awtextra.AbsoluteConstraints(223, 300, 32, 32));
        getContentPane().add(obstaculo23, new org.netbeans.lib.awtextra.AbsoluteConstraints(535, 372, 32, 32));
        getContentPane().add(obstaculo24, new org.netbeans.lib.awtextra.AbsoluteConstraints(336, 337, 32, 32));
        getContentPane().add(obstaculo25, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 266, 31, 32));
        getContentPane().add(obstaculo26, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 195, 32, 32));
        getContentPane().add(obstaculo27, new org.netbeans.lib.awtextra.AbsoluteConstraints(391, 197, 32, 32));
        getContentPane().add(obstaculo28, new org.netbeans.lib.awtextra.AbsoluteConstraints(258, 372, 32, 32));
        getContentPane().add(obstaculo29, new org.netbeans.lib.awtextra.AbsoluteConstraints(467, 302, 32, 32));
        getContentPane().add(obstaculo30, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 266, 32, 32));
        getContentPane().add(obstaculo31, new org.netbeans.lib.awtextra.AbsoluteConstraints(519, 0, 27, 100));
        getContentPane().add(obstaculo32, new org.netbeans.lib.awtextra.AbsoluteConstraints(711, 0, 50, 100));
        getContentPane().add(obstaculo33, new org.netbeans.lib.awtextra.AbsoluteConstraints(111, 100, 550, 330));
        getContentPane().add(obstaculoCerca, new org.netbeans.lib.awtextra.AbsoluteConstraints(375, 430, 0, 40));
        getContentPane().add(obstaculoPuente1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 70, 140));
        getContentPane().add(obstaculoPuente2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 250, 40, 90));
        getContentPane().add(obstaculoPuente3, new org.netbeans.lib.awtextra.AbsoluteConstraints(646, 170, 60, 120));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/escenarios/escenario1/v17.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana17_s1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Ventana17_s1().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel obstaculo29;
    private javax.swing.JLabel obstaculo3;
    private javax.swing.JLabel obstaculo30;
    private javax.swing.JLabel obstaculo31;
    private javax.swing.JLabel obstaculo32;
    private javax.swing.JLabel obstaculo33;
    ...
    private void cargarObstaculos() {
        ...
        this.obstaculos.add(this.obstaculo29);
        this.obstaculos.add(this.obstaculo30);
        this.obstaculos.add(this.obstaculo31);
        this.obstaculos.add(this.obstaculo32);
    ...
    public void validarDesactivacion()
    {
        ...
        new HiloPuente(interruptor2,5000,obstaculoPuente1,puente1,"caminover").start();
    }
        ...
        public void keyPressed(KeyEvent e)
        {
            ...
            switch(keyCode)
            {
                ...
                case (KeyEvent.VK_UP): if(!desplazamiento.obstaculoArr(tahi, obstaculosArriba) && !d.isVentanaAbierta())//Se valida si hay obstaculo
                                       ...
                                       {
                                          desplazamiento.cambiarPantalla(GestorJuego.getInstance().getvJF()[getNumVentanaFila()][getNumVentanaColm()],GestorJuego.getInstance().getvJF()[getNumVentanaFila()-1][getNumVentanaColm()-1],tahi,tahi.getX(),fondo.getHeight()-tahi.getHeight(),SPEED);    
                                          Sonidos.getInstance().detener(clip1);;i=0;
                                          removerCaja();
                                       }
                                       break;
                ...
                case (KeyEvent.VK_SPACE): if(GestorJuego.getInstance().getRecursos()[0])
                                          ...
                                          { 
                                            ...
                                            {
                                              new HiloPuente(interruptor1,5000,obstaculoPuente2,puente2,"caminohor").start();
                                            }
                                            else if(desplazamiento.contiene(interruptor2, tahi.getLocation()))
                                            {
                                              new HiloPuente(interruptor2,5000,obstaculoPuente3,puente3,"caminohor").start();  
                                            }
                                          }
                                          break;
    ...
    class MovimientoCaja extends Thread
    {
       ...
       {          
         while(!desplazamiento.obstaculoArr(caja,obstaculosArriba))
         {  
       ...
       {          
         while(!desplazamiento.obstaculoDer(caja,obstaculosDerecha))
         {  
       ...
       {          
         while(!desplazamiento.obstaculoIzq(caja,obstaculosIzquierda))
         {  
           caja.setLocation(caja.getX()-1,caja.getY());
           try {Thread.sleep(velocidad);} catch (InterruptedException ex) {}            
         }
    ...
    {       
       ...
       public HiloPuente(JLabel jl, int t, JLabel obs, JLabel p, String tipoPuente)
       {
         this.interruptor = jl;  
         this.tiempo = t;
         this.obs = obs;
       ...
       {           
          ...
          Icon[] vec = new Icon[6];
          vec[0] = new ImageIcon (getClass().getResource("imagenes/objetos/"+tipoPuente+"1.png"));
          vec[1] = new ImageIcon (getClass().getResource("imagenes/objetos/"+tipoPuente+"2.png"));
          vec[2] = new ImageIcon (getClass().getResource("imagenes/objetos/"+tipoPuente+"3.png"));
          vec[3] = new ImageIcon (getClass().getResource("imagenes/objetos/"+tipoPuente+"4.png"));
          vec[4] = new ImageIcon (getClass().getResource("imagenes/objetos/"+tipoPuente+"5.png"));
          vec[5] = new ImageIcon (getClass().getResource("imagenes/objetos/"+tipoPuente+"6.png"));
           
          interruptor.setIcon(on); 
          Sonidos.getInstance().reproducir("success1");
          
          for(int i=vec.length-1; i>=0; i--)
          {
            try { Thread.sleep(250); } catch (InterruptedException ex) {}  
            puente.setIcon(vec[i]);
          }
          
          obstaculosArriba.quitarObstaculo(obs, obstaculosArriba, obstaculosAbajo, obstaculosDerecha, obstaculosIzquierda, SPEED);
