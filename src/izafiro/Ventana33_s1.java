 ...
 * @author Jacc89
 */
public final class Ventana33_s1 extends javax.swing.JFrame {
    ...
    public Ventana33_s1() {
        ...
        this.addKeyListener(new Ventana33_s1.AL());//ActionListener para el movimiento del personaje   
    ...
    private void initComponents() {
        ...
        getContentPane().add(objeto1, new org.netbeans.lib.awtextra.AbsoluteConstraints(358, 10, -1, 78));
        ...
        getContentPane().add(objeto2, new org.netbeans.lib.awtextra.AbsoluteConstraints(358, 345, -1, 78));

        objeto3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        objeto3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/muro1.png"))); // NOI18N
        objeto3.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        getContentPane().add(objeto3, new org.netbeans.lib.awtextra.AbsoluteConstraints(63, 398, -1, 40));

        objeto4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        objeto4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/muro1.png"))); // NOI18N
        objeto4.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        getContentPane().add(objeto4, new org.netbeans.lib.awtextra.AbsoluteConstraints(195, 398, -1, 40));

        objeto5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        objeto5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/muro1.png"))); // NOI18N
        objeto5.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        getContentPane().add(objeto5, new org.netbeans.lib.awtextra.AbsoluteConstraints(483, 398, -1, 40));

        objeto6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        objeto6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/muro1.png"))); // NOI18N
        objeto6.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        getContentPane().add(objeto6, new org.netbeans.lib.awtextra.AbsoluteConstraints(618, 398, -1, 40));

        fuente1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/fuente.gif"))); // NOI18N
        getContentPane().add(fuente1, new org.netbeans.lib.awtextra.AbsoluteConstraints(127, 160, -1, -1));

        fuente2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/fuente.gif"))); // NOI18N
        getContentPane().add(fuente2, new org.netbeans.lib.awtextra.AbsoluteConstraints(528, 160, -1, -1));
        ...
        getContentPane().add(tahi, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 0, -1, -1));
        tahi.getAccessibleContext().setAccessibleName("tahi");

        hermitano.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/hermitano5.png"))); // NOI18N
        getContentPane().add(hermitano, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 280, -1, -1));
        getContentPane().add(obstaculo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 348, 70));
        getContentPane().add(obstaculo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(458, 0, 340, 70));
        getContentPane().add(obstaculo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 50, 490));
        getContentPane().add(obstaculo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(755, 0, 45, 480));
        getContentPane().add(obstaculo5, new org.netbeans.lib.awtextra.AbsoluteConstraints(454, 425, 340, -1));
        getContentPane().add(obstaculo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(26, 425, 330, 0));
        getContentPane().add(obstaculo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(163, 193, 87, 75));
        getContentPane().add(obstaculo8, new org.netbeans.lib.awtextra.AbsoluteConstraints(565, 193, 87, 75));
        getContentPane().add(obstaculo9, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 78, 20, 10));
        getContentPane().add(obstaculo10, new org.netbeans.lib.awtextra.AbsoluteConstraints(433, 78, 20, 10));
        getContentPane().add(obstaculo11, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 413, 20, 10));
        getContentPane().add(obstaculo12, new org.netbeans.lib.awtextra.AbsoluteConstraints(432, 413, 20, 10));
        getContentPane().add(obstaculo13, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 440, 348, 50));
        getContentPane().add(obstaculo14, new org.netbeans.lib.awtextra.AbsoluteConstraints(458, 440, 340, 50));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/escenarios/escenario1/v33.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana33_s1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Ventana33_s1().setVisible(true);
            }
        });
    }
    ...
    private void cargarPersonajes() {
       ...
       ArrayList<Conversacion>conversaciones1 = new ArrayList<>();
        ...
        dialogo1.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[3,3]/conversador1/dialogo1/1.png")));      
        dialogo1.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[3,3]/conversador1/dialogo1/2.png")));
        conversaciones1.add(dialogo1);
       
      Conversador conversador4 = new Conversador(0,hermitano,conversaciones1);
    ...
    private void cargarObstaculos() {
        ...
        this.obstaculos.add(this.hermitano);
        //----------------------------------------------------------------------
