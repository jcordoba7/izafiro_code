 ...
 * @author Jacc89
 */
public final class Ventana01_s1 extends javax.swing.JFrame {
    ...
    private boolean cercaRetirada = false;
    ...
    public Ventana01_s1() {
        ...
        this.addKeyListener(new Ventana01_s1.AL());//ActionListener para el movimiento del personaje
    ...
    private void initComponents() {
        ...
        cerca2 = new javax.swing.JLabel();
        cerca1 = new javax.swing.JLabel();
        ...
        obstaculoCerca1 = new javax.swing.JLabel();
        obstaculoCerca2 = new javax.swing.JLabel();
        ...
        flecha2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/flechaarriba.gif"))); // NOI18N
        getContentPane().add(flecha2, new org.netbeans.lib.awtextra.AbsoluteConstraints(605, 100, 0, 0));
        ...
        cerca2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/cerca2.png"))); // NOI18N
        cerca2.setPreferredSize(new java.awt.Dimension(103, 32));
        getContentPane().add(cerca2, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 450, -1, -1));

        cerca1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/cerca2.png"))); // NOI18N
        cerca1.setPreferredSize(new java.awt.Dimension(103, 32));
        getContentPane().add(cerca1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 450, -1, -1));
        ...
        getContentPane().add(bat1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 200, -1, -1));

        tahi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/personajes/tahi/tahi2.png"))); // NOI18N
        getContentPane().add(tahi, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 300, -1, -1));
        ...
        getContentPane().add(flecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 170, 0, 0));
        ...
        getContentPane().add(troncoTiempo, new org.netbeans.lib.awtextra.AbsoluteConstraints(587, 40, 70, -1));
        troncoTiempo.getAccessibleContext().setAccessibleName("troncoTiempo");

        getContentPane().add(obstaculo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(685, 34, 114, 240));
        getContentPane().add(obstaculo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 0, 80, 100));
        getContentPane().add(obstaculo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 180, 65));
        getContentPane().add(obstaculo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(701, 356, 97, 140));
        getContentPane().add(obstaculo5, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 70, 240, 180));
        getContentPane().add(obstaculo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 260, 380, 0));
        getContentPane().add(obstaculo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 0, 90, 90));
        getContentPane().add(obstaculo8, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 0, 110, 98));
        getContentPane().add(obstaculo9, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 345, 380, 10));
        getContentPane().add(obstaculo10, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 365, 240, 130));
        getContentPane().add(obstaculo11, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 420, 40, 70));
        getContentPane().add(obstaculo12, new org.netbeans.lib.awtextra.AbsoluteConstraints(254, 456, 340, 30));
        getContentPane().add(obstaculo13, new org.netbeans.lib.awtextra.AbsoluteConstraints(287, 0, 40, 150));
        getContentPane().add(obstaculo14, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, 680, 410));
        getContentPane().add(obstaculoCerca1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 477, 130, 0));
        getContentPane().add(obstaculoCerca2, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 477, 100, -1));
        getContentPane().add(obstaculo15, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 357, 116, 140));

        cascada.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/cascada.gif"))); // NOI18N
        getContentPane().add(cascada, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 0, 121, 118));

        cascada2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/cascada.gif"))); // NOI18N
        getContentPane().add(cascada2, new org.netbeans.lib.awtextra.AbsoluteConstraints(305, 0, 14, 88));
        getContentPane().add(agua, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 70, 280, 410));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/escenarios/escenario1/v01.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana01_s1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Ventana01_s1().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel cerca1;
    private javax.swing.JLabel cerca2;
    ...
    private javax.swing.JLabel obstaculoCerca1;
    private javax.swing.JLabel obstaculoCerca2;
    ...
    private void cargarPersonajes() {
       ...
       dialogo0.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[0,1]/conversador1/dialogo1/1.png"))); 
       dialogo0.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[0,1]/conversador1/dialogo1/2.png")));
       ...
       //Se agregan los diferentes dialogos de conversador 3 (agua).
      
       ArrayList<Conversacion>conversaciones2 = new ArrayList<>();
       
       Conversacion dialogo1 = new Conversacion();                
       dialogo1.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[0,1]/conversador2/dialogo1/1.png")));
       
       Conversacion dialogo2 = new Conversacion();                
       dialogo2.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[0,1]/conversador2/dialogo2/1.png")));
       
       Conversacion dialogo3 = new Conversacion();                
       dialogo3.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[0,1]/conversador2/dialogo3/1.png")));
       
       conversaciones2.add(dialogo1);
       conversaciones2.add(dialogo2);
       conversaciones2.add(dialogo3);
       
       Conversador conversador2 = new Conversador(0,agua,conversaciones2);
    ...
    private void cargarObstaculos() {
        ...
        this.obstaculos.add(this.obstaculoCerca1);
        this.obstaculos.add(this.obstaculoCerca2);
    ...
    {        
        ...
        int cont = 0; //bandera para mostrar los mensajes de aperura.
        ...
        public void keyPressed(KeyEvent e)
        {
            ...
            if(GestorJuego.getInstance().getMsnApertura()[3] && !cercaRetirada)
            {
               cerca1.setSize(0,0);
               obstaculosArriba.quitarObstaculo(obstaculoCerca1, obstaculosArriba, obstaculosAbajo, obstaculosDerecha, obstaculosIzquierda, SPEED);
               cerca2.setSize(0,0);
               obstaculosArriba.quitarObstaculo(obstaculoCerca2, obstaculosArriba, obstaculosAbajo, obstaculosDerecha, obstaculosIzquierda, SPEED);
               cercaRetirada = true;
            }
            
            if(!mensajeMostrado && !GestorJuego.getInstance().getMsnApertura()[3])
            {
               mensajeApertura();
               flecha.setSize(flecha.getPreferredSize()); 
               new MostrarFlechaReloj(flecha2).start();
                ...
                case (KeyEvent.VK_ENTER): if( !d.isVentanaAbierta() )
                                          {
                                             ...
                                             else if(desplazamiento.contiene(troncoTiempo, tahi.getLocation()))// Cerca del tronco del tiempo.
                                             {
                                               if(sv.i == 0)
                                               {        
    ...
    public class MostrarFlechaReloj extends Thread
    {
        JLabel label;

        public MostrarFlechaReloj(JLabel label)
        {
            this.label = label;
        }        
