 ...
 * @author Jacc89
 */
public final class Ventana53_s1 extends javax.swing.JFrame {
    ...
    public Ventana53_s1() {
        ...
        this.addKeyListener(new Ventana53_s1.AL());//ActionListener para el movimiento del personaje   
    ...
    private void initComponents() {
        ...
        getContentPane().add(fuente1, new org.netbeans.lib.awtextra.AbsoluteConstraints(197, 173, -1, -1));

        fuente2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/fuente.gif"))); // NOI18N
        getContentPane().add(fuente2, new org.netbeans.lib.awtextra.AbsoluteConstraints(328, 173, -1, -1));

        fuente3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/fuente.gif"))); // NOI18N
        getContentPane().add(fuente3, new org.netbeans.lib.awtextra.AbsoluteConstraints(466, 173, -1, -1));
        ...
        getContentPane().add(soldado2, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 355, -1, -1));
        ...
        getContentPane().add(soldado1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 100, -1, -1));
        ...
        getContentPane().add(soldado3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 355, -1, -1));
        ...
        getContentPane().add(obstaculo5, new org.netbeans.lib.awtextra.AbsoluteConstraints(484, 425, 300, 0));
        getContentPane().add(obstaculo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(26, 425, 300, -1));
        getContentPane().add(obstaculo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(123, 150, 550, 175));
        getContentPane().add(obstaculo8, new org.netbeans.lib.awtextra.AbsoluteConstraints(458, 440, 340, 50));
        getContentPane().add(obstaculo9, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 55, 50, 5));
        getContentPane().add(obstaculo10, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 440, 348, 50));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/escenarios/escenario1/v53.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana53_s1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Ventana53_s1().setVisible(true);
            }
        });
    }
    ...
    { 
        ...
        public void keyPressed(KeyEvent e)
        {
            ...
            if(senal.i == 0)
            {
              ...
              puntos [0] = new Point(70,100);
              puntos [1] = new Point(700,100);
              puntos [2] = new Point(700,355);
              puntos [3] = new Point(70,355);
              
              int[] vec = new int[3];
              vec[0] = 5; vec[1] = 3;
             
              soldados.add(new Soldado(soldado1,tahi,puntos,50,1,obstaculosAbajo,obstaculosArriba,obstaculosIzquierda,obstaculosDerecha,0,vec,senal,clip1,soldados,10));
              soldados.add(new Soldado(soldado2,tahi,puntos,50,1,obstaculosAbajo,obstaculosArriba,obstaculosIzquierda,obstaculosDerecha,0,vec,senal,clip1,soldados,10));
              soldados.add(new Soldado(soldado3,tahi,puntos,30,1,obstaculosAbajo,obstaculosArriba,obstaculosIzquierda,obstaculosDerecha,0,vec,senal,clip1,soldados,10));
