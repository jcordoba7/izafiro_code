 ...
 * @author Jacc89
 */
public final class Ventana25_s1 extends javax.swing.JFrame {
    ...
    public Ventana25_s1() {
        ...
        this.addKeyListener(new Ventana25_s1.AL());//ActionListener para el movimiento del personaje   
    ...
    private void initComponents() {
        ...
        getContentPane().add(roca4, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 340, -1, -1));

        roca3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/rocaaba.gif"))); // NOI18N
        getContentPane().add(roca3, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 120, -1, -1));
        ...
        getContentPane().add(bat1, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 240, -1, -1));
        ...
        getContentPane().add(bat2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 220, -1, -1));
        ...
        getContentPane().add(obstaculo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 345, 260, 150));
        getContentPane().add(obstaculo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 70, 130));
        getContentPane().add(obstaculo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 50, 110));
        getContentPane().add(obstaculo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 0, 740, 50));
        getContentPane().add(obstaculo5, new org.netbeans.lib.awtextra.AbsoluteConstraints(227, 25, 400, 50));
        getContentPane().add(obstaculo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(311, 300, 20, 40));
        getContentPane().add(obstaculo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 210, 365, 0));
        getContentPane().add(obstaculo8, new org.netbeans.lib.awtextra.AbsoluteConstraints(555, 295, 0, 170));
        getContentPane().add(obstaculo9, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 288, 365, -1));
        getContentPane().add(obstaculo10, new org.netbeans.lib.awtextra.AbsoluteConstraints(311, 100, 245, 100));
        getContentPane().add(obstaculo11, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 422, 800, 170));
        getContentPane().add(obstaculo12, new org.netbeans.lib.awtextra.AbsoluteConstraints(272, 107, 30, 10));
        getContentPane().add(obstaculo13, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 215, 50, 50));
        getContentPane().add(obstaculo14, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 195, 350, 100));
        ...
        getContentPane().add(cascada1, new org.netbeans.lib.awtextra.AbsoluteConstraints(436, 19, 121, 88));
        ...
        getContentPane().add(cascada, new org.netbeans.lib.awtextra.AbsoluteConstraints(311, 19, 121, 88));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/escenarios/escenario1/v25.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana25_s1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Ventana25_s1().setVisible(true);
            }
        });
    }
    ...
    private void cargarPersonajes() {
       ...
       new Rodante(this,tahi,"vertical",120,340,roca3,i1,i2,3,55,5,10).start();
       new Rodante(this,tahi,"vertical",120,340,roca4,i1,i2,3,55,5,10).start();
