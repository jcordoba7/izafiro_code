 ...
 * @author Jacc89
 */
public final class Ventana03_s1 extends javax.swing.JFrame {
    ...
    public Ventana03_s1() {
        ...
        this.addKeyListener(new Ventana03_s1.AL());//ActionListener para el movimiento del personaje        
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(flecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 480, 0, 0));
        ...
        getContentPane().add(flecha2, new org.netbeans.lib.awtextra.AbsoluteConstraints(625, 100, 0, 0));
        ...
        hora.setFont(new java.awt.Font("DS-Digital", 1, 19)); // NOI18N
        ...
        cuadroDialogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/dialogos/escenario1/ventana[0,3]/conversador1/dialogo1/1.png"))); // NOI18N
        ...
        fogata.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/flama.gif"))); // NOI18N
        fogata.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        fogata.setName("tahi"); // NOI18N
        getContentPane().add(fogata, new org.netbeans.lib.awtextra.AbsoluteConstraints(425, 250, -1, 30));

        tiempo.setBackground(new java.awt.Color(235, 255, 235));
        ...
        tahi.setName("tahi"); // NOI18N
        getContentPane().add(tahi, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 200, -1, -1));
        ...
        getContentPane().add(troncoTiempo, new org.netbeans.lib.awtextra.AbsoluteConstraints(557, 100, 70, -1));
        troncoTiempo.getAccessibleContext().setAccessibleName("troncoTiempo");

        obstaculo1.setBackground(new java.awt.Color(0, 102, 0));
        getContentPane().add(obstaculo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 60, 250, 70));
        getContentPane().add(obstaculo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(557, 250, 20, 10));
        getContentPane().add(obstaculo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(534, 227, 17, 33));
        getContentPane().add(obstaculo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 180, 80, 10));
        getContentPane().add(obstaculo5, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 270, 20, 10));
        getContentPane().add(obstaculo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 415, 473, 70));
        getContentPane().add(obstaculo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(549, 384, 250, 90));
        getContentPane().add(obstaculo8, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 444, 70, 30));
        getContentPane().add(obstaculo9, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 352, 220, 30));
        getContentPane().add(obstaculo10, new org.netbeans.lib.awtextra.AbsoluteConstraints(611, 257, 180, 100));
        getContentPane().add(obstaculo11, new org.netbeans.lib.awtextra.AbsoluteConstraints(644, 224, 150, 40));
        getContentPane().add(obstaculo12, new org.netbeans.lib.awtextra.AbsoluteConstraints(675, 180, 120, 50));
        getContentPane().add(obstaculo13, new org.netbeans.lib.awtextra.AbsoluteConstraints(643, 100, 150, 90));
        getContentPane().add(obstaculo14, new org.netbeans.lib.awtextra.AbsoluteConstraints(553, 110, 100, 50));

        obstaculo15.setBackground(new java.awt.Color(0, 102, 0));
        getContentPane().add(obstaculo15, new org.netbeans.lib.awtextra.AbsoluteConstraints(227, 92, 90, 100));

        obstaculo16.setBackground(new java.awt.Color(0, 102, 0));
        getContentPane().add(obstaculo16, new org.netbeans.lib.awtextra.AbsoluteConstraints(233, 180, 20, 50));

        obstaculo17.setBackground(new java.awt.Color(0, 102, 0));
        getContentPane().add(obstaculo17, new org.netbeans.lib.awtextra.AbsoluteConstraints(43, 227, 241, 95));

        obstaculo18.setBackground(new java.awt.Color(0, 102, 0));
        getContentPane().add(obstaculo18, new org.netbeans.lib.awtextra.AbsoluteConstraints(134, 280, 60, 70));

        obstaculo19.setBackground(new java.awt.Color(0, 102, 0));
        getContentPane().add(obstaculo19, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 260, 70, 27));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/escenarios/escenario1/v03.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana03_s1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Ventana03_s1().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel fogata;
    ...
    private void cargarPersonajes() {
      ...
      conversacion1.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[0,3]/conversador1/dialogo1/1.png"))); 
      conversacion1.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[0,3]/conversador1/dialogo1/2.png")));
      conversacion1.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[0,3]/conversador1/dialogo1/3.png"))); 
      conversacion1.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[0,3]/conversador1/dialogo1/4.png")));
              
      conversaciones1.add(conversacion1);
    ...
    {  
        ...
        public void keyPressed(KeyEvent e)
        {
            ...
            if(!GestorJuego.getInstance().getMsnApertura()[0])
            {
              mensajeApertura();
              GestorJuego.getInstance().getMsnApertura()[0] = true;
            }
                ...
                case (KeyEvent.VK_ENTER): if( !d.isVentanaAbierta() )
                                          {
                                             ...
                                             else if(desplazamiento.contiene(troncoTiempo, tahi.getLocation()))// Cerca al reloj.
                                             {
                                               if(sv.i == 0)
                                               {  
                                                  flecha2.setSize(0,0); 
                                                  new Reloj(GestorJuego.getInstance().getvJF()[getNumVentanaFila()][getNumVentanaColm()],sv).start();
                                                  new MostrarFlechaReloj(flecha).start();
                                               }
                                             }
                                          }
                                          else
