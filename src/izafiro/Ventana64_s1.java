 ...
 * @author Jacc89
 */
public final class Ventana64_s1 extends javax.swing.JFrame {
    ...
    public Ventana64_s1() {
        ...
        this.addKeyListener(new Ventana64_s1.AL());//ActionListener para el movimiento del personaje 
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(soldado2, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 320, -1, -1));
        ...
        getContentPane().add(soldado1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 70, -1, -1));
        ...
        getContentPane().add(troncoTiempo, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 130, -1, -1));
        troncoTiempo.getAccessibleContext().setAccessibleName("troncoTiempo");

        getContentPane().add(obstaculo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 40, 230));
        getContentPane().add(obstaculo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(268, 0, 530, 45));
        getContentPane().add(obstaculo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 280, 175));
        getContentPane().add(obstaculo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 0, 40, 295));
        getContentPane().add(obstaculo5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 397, 800, 180));
        getContentPane().add(obstaculo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(284, 0, 20, 310));
        getContentPane().add(obstaculo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 110, 27, 170));
        getContentPane().add(obstaculo8, new org.netbeans.lib.awtextra.AbsoluteConstraints(465, 105, 167, 170));
        getContentPane().add(obstaculo9, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 110, 27, 170));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/escenarios/escenario1/v64.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana64_s1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Ventana64_s1().setVisible(true);
            }
        });
    }
    ...
    {       
        ...
        public void keyPressed(KeyEvent e)
        {
            ...
            {              
              ...
              puntos [0] = new Point(380,70);
              puntos [1] = new Point(640,70);
              puntos [2] = new Point(640,320);
              puntos [3] = new Point(380,320);
              
              int[] vec = new int[3];
              vec[0] = 6; vec[1] = 4;
             
              soldados.add(new Soldado(soldado1,tahi,puntos,60,1,obstaculosAbajo,obstaculosArriba,obstaculosIzquierda,obstaculosDerecha,1,vec,senal,null,soldados,35));
              soldados.add(new Soldado(soldado2,tahi,puntos,40,1,obstaculosAbajo,obstaculosArriba,obstaculosIzquierda,obstaculosDerecha,1,vec,senal,null,soldados,35));
