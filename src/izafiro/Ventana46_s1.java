 ...
 * @author Jacc89
 */
public final class Ventana46_s1 extends javax.swing.JFrame {
    ...
    public Ventana46_s1() {
        ...
        this.addKeyListener(new Ventana46_s1.AL());//ActionListener para el movimiento del personaje   
    ...
    private void initComponents() {
        ...
        getContentPane().add(objeto2, new org.netbeans.lib.awtextra.AbsoluteConstraints(398, 350, -1, 80));

        fuente1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/fuente.gif"))); // NOI18N
        getContentPane().add(fuente1, new org.netbeans.lib.awtextra.AbsoluteConstraints(182, 282, -1, -1));

        fuente2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/objetos/fuente.gif"))); // NOI18N
        getContentPane().add(fuente2, new org.netbeans.lib.awtextra.AbsoluteConstraints(555, 282, -1, -1));
        ...
        gema.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/barra/recursos/recurso6.png"))); // NOI18N
        getContentPane().add(gema, new org.netbeans.lib.awtextra.AbsoluteConstraints(432, 8, -1, -1));
        getContentPane().add(obstaculo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(175, 100, 170, 170));
        getContentPane().add(obstaculo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(545, 100, 170, 170));
        getContentPane().add(obstaculo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 85, 490));
        getContentPane().add(obstaculo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 325, 60, 50));
        getContentPane().add(obstaculo5, new org.netbeans.lib.awtextra.AbsoluteConstraints(607, 323, 60, 50));
        getContentPane().add(obstaculo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(472, 425, 20, 0));
        getContentPane().add(obstaculo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 430, 20, -1));
        getContentPane().add(obstaculo8, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 440, 330, 50));
        getContentPane().add(obstaculo9, new org.netbeans.lib.awtextra.AbsoluteConstraints(73, 0, 720, 70));
        getContentPane().add(obstaculo11, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 440, 300, 50));
        getContentPane().add(obstaculo12, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 0, 30, 490));
        getContentPane().add(obstaculo13, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 0, 50, 70));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/escenarios/escenario1/v46.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana46_s1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Ventana46_s1().setVisible(true);
            }
        });
    }
    ...
    private void cargarPersonajes() {
       ...
       ArrayList<Conversacion>conversaciones1 = new ArrayList<>();
        ...
        dialogo0.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[5,6]/conversador1/dialogo1/1.png")));      
        dialogo0.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[5,6]/conversador1/dialogo1/2.png")));
        dialogo0.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[5,6]/conversador1/dialogo1/3.png")));
        dialogo0.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[5,6]/conversador1/dialogo1/4.png")));
        dialogo0.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[5,6]/conversador1/dialogo1/5.png")));
        
        Conversacion dialogo1 = new Conversacion();
        dialogo1.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[5,6]/conversador1/dialogo2/1.png")));    
    ...
    {       
        ...
        public void keyPressed(KeyEvent e)
        {
            ...
            switch(keyCode)
            {
                ...
                case (KeyEvent.VK_Y): if(cuadroDialogo.getIcon().toString().contains("conversador1/dialogo1/5"))
                                      {
                                        Sonidos.getInstance().detener(clip1);i=0;  
                                        PruebaPuzzle.getInstance().abrirActividad(7,GestorJuego.getInstance().getvJF()[getNumVentanaFila()][getNumVentanaColm()],new Point(tahi.getX(),tahi.getY()));
                                        conversadores.get(0).setDialogoActual(conversadores.get(0).getDialogoActual()+1);                                       
                                        puzzle = true;
                                      }else if(cuadroDialogo.getIcon().toString().contains("conversador1/dialogo2/1"))
                                      {
                                        Sonidos.getInstance().detener(clip1);i=0;   
                                        PruebaPuzzle.getInstance().abrirActividad(7,GestorJuego.getInstance().getvJF()[getNumVentanaFila()][getNumVentanaColm()],new Point(tahi.getX(),tahi.getY()));                                        
                                      }
        ...
        {          
          if(cuadroDialogo.getIcon().toString().contains("conversador1/dialogo2/1")) //Se le dará la gema azul
          { 
            GestorJuego.getInstance().agregarRecurso(6); //gema 2 es el recurso No 6.             
          }
        }
