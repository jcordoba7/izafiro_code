 ...
 * @author Jacc89
 */
public final class Ventana39_s1 extends javax.swing.JFrame {
    ...
    public Ventana39_s1() {
        ...
        this.addKeyListener(new Ventana39_s1.AL());//ActionListener para el movimiento del personaje  
    ...
    private void initComponents() {
        ...
        getContentPane().add(numPuntaje1, new org.netbeans.lib.awtextra.AbsoluteConstraints(725, 453, 14, 29));
        ...
        getContentPane().add(numPuntaje2, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 453, 14, 29));
        ...
        getContentPane().add(numPuntaje3, new org.netbeans.lib.awtextra.AbsoluteConstraints(755, 453, 14, 29));
        ...
        getContentPane().add(numPuntaje4, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 453, 14, 29));
        ...
        getContentPane().add(marcoPuntaje, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 450, 70, 35));
        ...
        getContentPane().add(puntaje, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 430, -1, -1));
        ...
        getContentPane().add(cascada1, new org.netbeans.lib.awtextra.AbsoluteConstraints(157, -61, 121, 88));
        ...
        getContentPane().add(cascada6, new org.netbeans.lib.awtextra.AbsoluteConstraints(281, -61, 121, 88));
        ...
        getContentPane().add(cascada7, new org.netbeans.lib.awtextra.AbsoluteConstraints(496, -61, 121, 88));
        ...
        getContentPane().add(cascada9, new org.netbeans.lib.awtextra.AbsoluteConstraints(617, -61, 121, 88));
        ...
        getContentPane().add(cascada8, new org.netbeans.lib.awtextra.AbsoluteConstraints(738, -61, 61, 88));

        objeto1.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        ...
        getContentPane().add(objeto1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 37, 70, 367));
        ...
        getContentPane().add(tahi, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 420, -1, -1));
        tahi.getAccessibleContext().setAccessibleName("tahi");

        llave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/barra/recursos/recurso3.png"))); // NOI18N
        getContentPane().add(llave, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 10, -1, -1));
        getContentPane().add(obstaculo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 100, 10));
        getContentPane().add(obstaculo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 30, 402));
        getContentPane().add(obstaculo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(495, 0, 290, 40));
        getContentPane().add(obstaculo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 480, 160, -1));
        getContentPane().add(obstaculo5, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 0, 300, 40));
        getContentPane().add(obstaculo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(156, 130, 290, 40));
        getContentPane().add(obstaculo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(487, 130, 310, 40));
        getContentPane().add(obstaculo8, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 0, -1, 120));
        getContentPane().add(obstaculo9, new org.netbeans.lib.awtextra.AbsoluteConstraints(155, 133, -1, 350));
        getContentPane().add(obstaculo10, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 160, 60, 0));
        getContentPane().add(obstaculo11, new org.netbeans.lib.awtextra.AbsoluteConstraints(388, 0, 110, 0));
        getContentPane().add(obstaculo12, new org.netbeans.lib.awtextra.AbsoluteConstraints(463, 10, 20, 20));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/izafiro/imagenes/escenarios/escenario1/v39.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana39_s1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Ventana39_s1().setVisible(true);
            }
        });
    }
    ...
    private void cargarPersonajes() {
       ...
       ArrayList<Conversacion>conversaciones1 = new ArrayList<>();
        ...
        dialogo0.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[3,9]/conversador1/dialogo1/1.png")));      
        dialogo0.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[3,9]/conversador1/dialogo1/2.png")));
        dialogo0.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[3,9]/conversador1/dialogo1/3.png")));
        dialogo0.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[3,9]/conversador1/dialogo1/4.png")));
        dialogo0.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[3,9]/conversador1/dialogo1/5.png")));
        dialogo0.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[3,9]/conversador1/dialogo1/6.png")));
        dialogo0.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[3,9]/conversador1/dialogo1/7.png")));
        dialogo0.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[3,9]/conversador1/dialogo1/8.png")));
        
        Conversacion dialogo1 = new Conversacion();
        dialogo1.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[3,9]/conversador1/dialogo2/1.png")));      
        dialogo1.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[3,9]/conversador1/dialogo2/2.png")));
        dialogo1.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[3,9]/conversador1/dialogo2/3.png")));
        
        Conversacion dialogo2 = new Conversacion();
        dialogo2.getMensajes2().add(new ImageIcon (getClass().getResource("imagenes/dialogos/escenario1/ventana[3,9]/conversador1/dialogo2/4.png")));      
        
        if((GestorJuego.getInstance().getPuertas()[1] && GestorJuego.getInstance().getRecursos()[2])
       ...
       Conversador conversador1 = new Conversador(0,obstaculo12,conversaciones1);
    ...
    {  
       ...
       else
       {
         ...
         {
           if(!cuadroDialogo.getIcon().toString().contains("conversador1/dialogo1/8") || puzzle)
           {
    ...
    {       
        ...
        public void keyPressed(KeyEvent e)
        {
            ...
            switch(keyCode)
            {
                ...
                case (KeyEvent.VK_Y): if(cuadroDialogo.getIcon().toString().contains("conversador1/dialogo1/8"))
                                      {                                          
                                        PruebaPuzzle.getInstance().abrirActividad(5,GestorJuego.getInstance().getvJF()[getNumVentanaFila()][getNumVentanaColm()],new Point(tahi.getX(),tahi.getY()));
                                        conversadores.get(0).setDialogoActual(conversadores.get(0).getDialogoActual()+1);  
                                        Sonidos.getInstance().detener(clip1);;i=0;
                                        puzzle = true;
                                      }else if(cuadroDialogo.getIcon().toString().contains("conversador1/dialogo2/4"))
                                      {
                                        PruebaPuzzle.getInstance().abrirActividad(5,GestorJuego.getInstance().getvJF()[getNumVentanaFila()][getNumVentanaColm()],new Point(tahi.getX(),tahi.getY()));
                                        Sonidos.getInstance().detener(clip1);;i=0;  
                                      }
        ...
        {          
          if(cuadroDialogo.getIcon().toString().contains("conversador1/dialogo2/3")) //Se le dará la llave
          { 
